...
const SLUG = 'cfafrica-collection';

// App production config
const APP_NAME = 'CFAfrica Collection';
const BUNDLE_IDENTIFIER = 'com.cfafrica.collection';
const PACKAGE_NAME = 'com.cfafrica.collection';
const ICON = './assets/icon.png';
const ADAPTIVE_ICON = './assets/adaptive-icon.png';
const SCHEME = 'cfafrica-collection';
...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...
    extra: {
      eas: { projectId: 'c7b78a89-6fe3-4f72-b147-5e81865b5d46' },
    },
  };
};
