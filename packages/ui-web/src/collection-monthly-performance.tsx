...
export type CollectionMonthlyPerformanceFormValues = {
  id: number;
  year: number;
  month: number;
};

export type CollectionMonthlyPerformanceProps = {
  collectors?: Record<string, string>;
  onSubmit(
    values: CollectionMonthlyPerformanceFormValues
  ): Promise<{ message: string; success: boolean }>;
};

export function CollectionMonthlyPerformance(
  props: CollectionMonthlyPerformanceProps
) {
  ...
  return (
    <>
      {props.collectors && (
        <CollectionMonthlyPerformanceForm
          {...props}
          show={show}
          setShow={setShow}
        />
...
function CollectionMonthlyPerformanceForm(
  props: CollectionMonthlyPerformanceProps & {
    show: boolean;
    setShow: (show: boolean) => void;
  }
) {
  const initialValues: CollectionMonthlyPerformanceFormValues = {
  ...
  return (
    <Modal
      ...
      title="Generate Collection Monthly Performance"
    >
      <Formik
