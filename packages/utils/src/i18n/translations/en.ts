export const en = {
  ...
  kyc: {
    personal_info: {
      title: 'Personal info',
      subtitle: 'Please fill the form below with your personal information.',
    },
    front_id: {
      title: 'Front picture of ID',
      subtitle:
        'Please upload the front picture of your ID below for completing your second step of KYC.',
    },
    back_id: {
      title: 'Back picture of ID',
      subtitle:
        'Please upload the back picture of your ID below for completing your second step of KYC.',
    },
    photo: {
      title: 'Photo',
    ...
    birthdate: 'Birthdate',
    nid: 'ID number',
    emergency_number_1: 'Emergency number #1',
    emergency_number_1_name: 'Emergency number #1 name',
    emergency_number_2: 'Emergency number #2',
    emergency_number_2_name: 'Emergency number #2 name',
    front_photo: 'Upload ID front picture',
    back_photo: 'Upload ID back picture',
    selfie: 'Upload your photo',
    back: 'Back',
    next: 'Next',
    submit: 'Submit',
  ...
  beneficiary: {
    ...
    verify:
      'Please enter the verification code received via SMS to register the new beneficiary.',
    subtitle:
      'Please fill the form below with the needed amount and your photo.',
  ...
  privacy_policy: {
    ...
    content: `
The following Privacy Policy describes how we, CFAfrica and its Affiliates, collect, store, use, transfer, disclose and protect your Personal Information.
...
Whenever you use the Application through a mobile device, we may collect information about your SMS(time stamp, phone number, and SMS content), phone status, calendar, camera, advertising ID and other data with your permission. The information may be uploaded to the Company's servers and/or a Service Provider's server, or it may be simply stored on Your device. You can enable or disable access to this information at any time through your device settings.
...
Your Personal Information may be transferred to, stored, used and processed in a jurisdiction other than your home country or otherwise in the country, state and city in which you are located while using any Service provided by us ("Alternate Country") CFAfrica companies under Our Group which are outside your country or Foreign Country and/or where our CFAfrica group servers and/or service providers and partners are outside your country or Foreign Country.
In such event, We will ensure that such Personal Information continues to be subject to a level of protection consistent with that required under Côte d'Ivoiren Laws (and, in any event, in accordance with our commitments in this Privacy Policy).
...
If you have any questions about this Privacy Policy or would like to access and/or make corrections to your Personal Information, please contact us atCFAfrica@gmail.com
    `,
  },
  about_us: {
    title: 'About us',
    content: `1. About these Terms of Use
Please read these Terms of Use very carefully. These Terms and Conditions constitute the electronic financial service and end user license agreement, and by registering or using any part of the CFAfrica service (“Service”), You confirm that You have read, understood, accepted and agree to these Terms of Use and shall be bound by it. If you do not agree to be bound by these Terms, You may not access or use any part of the Service. These Terms and Conditions constitute a binding legal agreement between You, as an individual user (“You” or “Your”) and CFAfrica (“We”, “Us” or “Our”).
...
Business Day means a day other than Saturday, Sunday or a national or public holiday in the United Republic of Côte d'Ivoire;
Identifier means your personal identification used to access the Application/Service and operate Your Account;
Credit Reference Bureaux means the Credit Reference Bureau of Côte d'Ivoire to collect and facilitate the distribution of customer credit information;
...
Mobile Money Account means your mobile money store of value, being a record maintained by Mobile Money Providers Côte d'Ivoire of the amount of E-Money from time to time held by You in the Money Provider System by Phone;
...
System means the CFAfrica system provided by Us to provide users with the Services, including the Software and related programs, Websites, systems and other support systems and services.
...
4.9 You authorize CFAfrica to use the payment method with automatic deduction if you fail to repay the loan on the agreed repayment date by submitting this bank card confirmation.
...
18.10 We may give you notice through a general notice posted on the App or Platform or to your email address set forth in Your Account. You must give us notice by email to:CFAfrica@gmail.com
18.11 All complaints and suggestions related to the System and Services can be made by sending an email to: CFAfrica@gmail.com
    `,
  },
  language: {
    title: 'Language',
    subtitle:
      'Please select your preferred display language for the application.',
    en: 'See all the application written in english language',
    fr: 'See all the application text written in french language',
  },
  ui: {
    image_input: {
      permissions: {
        media_library: {
          ...
          subtitle: 'We need your permission to access your photos',
        },
        camera: {
          title: 'Permission denied',
          subtitle: 'We need your permission to access your camera',
        },
      },
    ...
    loan: {
      ...
      mode: 'Payment mode',
      amount: 'amount',
      merchant_mode: 'Use the following code to pay and send the proof',
    },
  },
};
