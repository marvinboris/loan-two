...
const SvgVg = (props: SvgProps) => (
  ...
  >
    ...
    <G transform="translate(-282.6 18.3)scale(.73883)">
      ...
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={-0.8} y={41.3} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={-1.1} y={82} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={25.6} y={126.1} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={-4.6} y={162.2} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={-3.8} y={204.8} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={146.3} y={0.7} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={144.9} y={41.2} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={143.1} y={82.7} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={145.2} y={123.4} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={144.7} y={164.2} />
      <Use xlinkHref="#vg_svg__b" width="100%" height="100%" x={144.9} y={205.2} />
