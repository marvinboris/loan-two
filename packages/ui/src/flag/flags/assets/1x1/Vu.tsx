...
const SvgVu = (props: SvgProps) => (
  ...
  >
    ...
    <G clipPath="url(#vu_svg__a)" transform="scale(.56889 1.0779)">
    ...
    <G fill="#fdce12" transform="translate(-35.6 26.7)scale(.96552)">
      <Path d="M106.9 283v27c23.5 0 69.7-18 69.7-76.1s-49.3-68.9-64-68.9c-14.8 0-60.3 10.6-60.3 58 0 47.6 44.7 52 53.5 52s41.8-8 38-43.6a35.5 35.5 0 0 1-35.4 31.5c-24 0-39-17.8-39-35.4s14.6-41.2 39.9-41.2 43.8 22.5 43.8 45.1c0 22.7-17.8 51.5-46.2 51.5z" />
      <G id="vu_svg__b">
        <Path
          stroke="#fdce12"
          strokeWidth={0.8}
      ...
      <Use xlinkHref="#vu_svg__b" width="100%" height="100%" transform="matrix(-1 0 0 1 220 0)" />
    </G>
  </Svg>
);
