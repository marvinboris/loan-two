...
import Svg, { Path, G, Rect, Use } from 'react-native-svg';
...
const SvgSz = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#ffd900" stroke="#000" transform="translate(-42.4 58.8)scale(.98607)">
      ...
      <Use xlinkHref="#sz_svg__a" width="100%" height="100%" x={-23.3} y={17.1} />
    ...
    <G stroke="#fff" transform="translate(-42.4 58.8)scale(.98607)">
      <G id="sz_svg__d" strokeWidth={6.9}>
        <G id="sz_svg__c">
          <Path id="sz_svg__b" d="M214 192.4v-22.9m13.8 0v22.9m13.8-22.9v22.9" />
    ...
    <G fill="#a70000">
      ...
      <Path
        fill="#b3b3b3"
        d="M28.7 282c1.8-4.4 3.4-5.7 4.6-8.5 2-5 2.3-9 4-8.4s1.7 2.6-.6 7.5c-2.3 5-3.3 6-8 9.4m6.8 11c.7-4 1.8-5.3 2.3-7.9.9-4.4.4-7.7 2-7.6 1.6.2 2 2 .9 6.3-1.1 4.5-1.8 5.5-5.3 9.2zm8 7.7c.3-3.8 1.2-5.3 1.3-7.8.3-4.3-.6-7.4 1-7.4 1.5 0 2 1.5 1.6 5.9-.5 4.3-1 5.4-3.8 9.3zm17.5-25c-3.3-3.3-5.3-4-7.5-6-3.7-3.8-5.6-7.3-7-6-1.3 1.2-.5 3 3.5 6.6s5.4 4.1 11 5.4m-2 12.9c-2.1-3.3-3.8-4.3-5.2-6.4-2.5-3.8-3.2-7-4.7-6.2-1.4.8-1 2.5 1.6 6.2 2.7 3.6 3.7 4.3 8.3 6.4"
      />
      <Path
        fill="#333"
        stroke="#000"
        strokeWidth={0.8}
        d="M207.9 186.5c-4 7.5 6.8-2.5 23.6 10.2a29 29 0 0 1 7.6 15.9 50.7 50.7 0 0 1-9.9-4.4s7.5 7.5 7.5 16.1c-2.7-1.6-4-1.4-5-3.4 0 2.8 2.5 4.5 2.5 8.8a35 35 0 0 0-5.2-3.4c2.5 4.3-4.5 12.7-1 15.4a21.9 21.9 0 0 1-14.9-9c-1.3.8-1.4 2.2-1.5 3.7.2.2-9.3-7-8.4-9.8a8.3 8.3 0 0 0-1.8 4.8 26 26 0 0 1-7.9-11.4l-3.2 4c-1.1-7-1.1-6.8 1.2-12.8a57 57 0 0 0-4.6 3.5 41 41 0 0 1 21-28.2z"
      />
      <Path
        fill="#b3b3b3"
