...
const SvgUg = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    <G clipPath="url(#ug_svg__a)" transform="translate(-128)scale(1.0321)">
      <Path fill="#ffe700" fillRule="evenodd" d="M0 330.7h744v82.7H0z" />
      <Path fill="#000001" fillRule="evenodd" d="M0 248h744v82.7H0z" />
      <Path fill="#de3908" fillRule="evenodd" d="M0 165.4h744V248H0z" />
      <Path fill="#ffe700" fillRule="evenodd" d="M0 82.7h744v82.7H0z" />
      <Path fill="#000001" fillRule="evenodd" d="M0 0h744v82.7H0z" />
      <Path
        fill="#fffdff"
        fillRule="evenodd"
        stroke="#000"
      ...
      <Path
        ...
        strokeLinejoin="round"
        strokeWidth={0.8}
        d="M364 208s-18.4 20.2-10.5 35.7c.5-2.2.3-3.5.5-3.4-.4-.3 2.3 1.8 2 1.4.2-1.1-.7-3.5-.7-3.5l2.4.6-1.4-2.7 3.5.5s-1.2-3.4-.8-3.4a94 94 0 0 1 2.9.2c-5.2-9.3-.3-17 2-25.3z"
      />
      <Path
        fill="#9ca69c"
        fillRule="evenodd"
      ...
      />
      <Path fill="#fff" fillRule="evenodd" d="M363.5 196.7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />
      <Path
        fill="#de3108"
        fillRule="evenodd"
        stroke="#000"
      ...
      <Path
        ...
        strokeLinejoin="round"
        strokeWidth={0.8}
        d="M385.8 254.4c-.3.1 21.6 12.9 15 23.9 6.3-4.1 4.2-11.4 4.2-11.4s5.1 13.3-7.3 19.8c1.4 1.2 2.2.9 2.2.9l-2 2.1s-1 1.6 7.3-2.4c-2.3 1.8-2.5 3.1-2.5 3.1s.7 1.8 6.1-3a30.1 30.1 0 0 0-5.4 7.2c12-1.1 37.8-39.7-8.1-51.1l2 2.2z"
      />
      <Path
        fill="#fff"
        fillRule="evenodd"
      ...
      />
      <Path fill="#de3908" fillRule="evenodd" d="M0 413.4h744v82.7H0z" />
    </G>
  </Svg>
);
