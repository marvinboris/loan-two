...
const SvgMt = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="#fff" stroke="#000" strokeWidth={96} transform="translate(109 119.6)scale(.00919)">
      <Path
        fill="none"
        stroke="#cf142b"
        strokeWidth={512}
    ...
    <G fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={36}>
      <Path strokeWidth={0.4} d="M94 135.4a368 368 0 0 1 29.9 0" />
      <Path strokeWidth={0.2} d="m107.8 108.8.8 1m1.2 12 .1 2m-2-2c.3.4.7 1.5.7 2" />
      <Path
        fill="#fff"
        strokeWidth={0.3}
        d="M114.1 135.3c-.3.1-1 .5-1 .8s.8.3 1 .4c-.4.2-1.6.4-2.2.1-.4.3-3.3-.4-3.9-.4-.3 0-.9-.3-.8-1 0-.2.1-.6.5-.7-.2-.3.7-1 1.5-1.4-1.3.1-3-.4-3.4-.9-1-.3-1.4 0-1.8.9 0 1.5-.9 2.2-1.9 2-.7 0-.8.3-1 .4l2 .6c1.4 1.3.6 2.3.3 2.5-.3.3-1 .1-1.5.1-.4 0-.4.2-.6.3-.3.1-.7.2-.8 0 0-.1.2-1 .8-1 .3-.1.9-.3 1-.6 0-.3-1.2-.2-2-.6-.8-.2-1-.6-.8-1.8s1.7-1.4 2.4-1.4c0-.5 0-1.5.7-2 1-1 2.5-.7 3.8-.6.8-.4 2.1-1 3.5-1 1.2-.1 6.6-1.5 9-1.2-.5-.9-.4-2.8.6-3.4 1.3-.7 2.7 1.3 3 1 .3-.4-.4-1-1.4-1.9-.2-.4-.1-.4-.1-.5l.1-.8c.1 0 .9.2 1 .5q.45.6.9.3c.3-.2-.1-.1-.3-.7 0-.2-.3-.4-.3-.7.2-.2 1-.8 1.5-1l.5.8c.5.7 1 .5 1.2 1 .1.2.1.7.3 1a6 6 0 0 0 2.2 2.3c.2.1.4.3.4.5l-.2.6h-1c-.7-.4-1-.6-1.3-.5-1 .1-1.5 1.5-2.7 1.5-1.2-.2-2-1.8-2.6-1.3-.7.5 1.6 1.9 1.3 2.5.2.1.5.6.4 1 1.2-.2 2-1 2.4-1.6.6-.9 1-1.3 1.4-1.5.4-.1.8.1.8.4l.6.1c.3.2.2.5 0 .7 0 0-.1-.2-.3-.2-.2-.1-.5.1-.7.3l-.7 1.1-1.3 1.3c.2.3 0 .7.1 1l.4.1v.5c0 .3-1.1 1.6-1.5 1.6-.5 0-.8-.6-.8-.8-.5.2-.8-.4-.8-.6-.2.3-1 .7-1.3.8-.3.2-.4.2-.5-.2-.1.3-.9.5-1 .6-1 .2-2 .6-3 .6H114z"
      />
      <Path
        fill="#fff"
        strokeWidth={0.2}
      ...
      <Path
        strokeWidth={0.3}
        d="M122 133.4c.9-.4 1.7-1 2.6-1.8m-16-.6c.7 0 2.4.3 2.9.9s.8 1.7-2.5 2.5c1 0 2.4-.2 3 0 .4-.2 1.5-.5 2-.4-.2.1-.8.3-.8.6s.2.4.7.5m3.2-2.2c1.2.2 2.8-.1 3 1.1"
      />
      <Path
        strokeWidth={0.2}
        d="m121 123.5 1.7 1.3c.6.5.9 0 .4-.9m-10.2 4.9c1.1-.3 2.8-.5 3.8-.5m-5.3-.8c1.8-.5 3.8-.3 5.1-.3m-.3 4c.3-.4 1-1 1.7-1.5m-3.4 0 2.5-.8m-2.7-4.7c1-1 2.2-.9 3.3-1.4.6-.4 1.2-1.3 1.9-2 .3-.2.5-.4 1.3-.4s.9.3-.2.5c-.7 0-.7.4-1 1-.3.4 0 1 .1 1.4l-.5 1.4c0 .2 0 .3.3.6m-10.2.6c2.6-.6 6.3.4 7 .4"
      />
      <Path
        strokeWidth={0.1}
      ...
      <Path
        fill="#fff"
        strokeWidth={0.3}
        d="M115.8 107.2a7 7 0 0 1-1.5.2l-.1 1.5c1.5 1.4 2.9 3.2 3 5 .5.3.7.7 1 1.4 1-.6 2.1-1.5 3-1.7.6-.1 1.7-.2 2.2.1l3.5 2.2c.7.4 1.2 1 1.6 1.5.4.6.4 1.5.3 1.8l-2.1-.6c-.2-.4 0-.8.1-1.2.2-.3.2-.3-.1-.5s-.5-.2-.7-.1a.7.7 0 0 1-.7-.4c-.2-.3-2.5-1.2-2.8-1.3-.4 0-1 0-1.4.4-.2.3-1 1.5-1.6 2-.1.2-.2.4 0 .5l2.2.1c.9.1 2 1 2.4 1.6l3.7 3.7c.3.3.6.7.5 1.1h-2a4.8 4.8 0 0 0-.3-1.7c-.2-.4-.7-.2-.9-.2-.1 0-.4-.3-.6-.7-.3-.6-1.4-1.4-2-1.7-.4-.3-.6-.2-1.1-.2-.4-.1-1.1-.2-1.6 0-.6.2-2.1.7-3.6.8-.5.3-2 .6-3.7 1l-4.7.7a7 7 0 0 1-2 3.4c-.4.6-.4 1-.1 1.3s2.4.3 3 .3h1.7c.4.1.9.5 1.4.8.4.3.5.5.7.9l.5.7h-2.5c0-.6-.3-1-.7-1-.3.2-.7.5-1.2.3l-5-.1c-.6 0-1-.8-.8-1.5s0-1.2 0-1.7l-1.3 1.4c-.7.7-.3 1.5 0 1.9a20 20 0 0 1 2.6 3l2 1.6c.2.6.7.9 1 1.3H104l.2-.8c0-.2-.2-.6-.7-.5-.4 0-.7-.5-.9-.8-.1-.5-1.5-2.3-2-2.7-.4-.4-1.6-1.7-1.9-1.8-.2 0-.2-.5 0-.8.3-.3 1-1.5 1.3-2.3.2-.6 0-.6-.1-.8-1.4-1-2.6-2.4-3.4-3.7-.2.1-1.8.1-2.5-.3-.6-.2-1.4-.3-1.8.3-.2.4-.2 1.1.2 1.5.6.4 1.3 1.2 2 2 .7 1 .1 1.5-.8 2.2.2.4 0 .3.2.9.3.4.3 1.4 0 1.7-.5.2-1 .4-1.4 1-.4.5-.6 0-.4-1 0-.5-.4-1-.7-1.3-.4-.5-.2-1.7 0-2 .3-.4.5-1.1 0-1.7-.6-.5-1.6-1.6-1.5-3.1.2-2 2.2-2.6 3.3-2 1.8.7 3 .6 3.5.4.5-.8 1.2-1.7 2.3-2.3 1-.6 3.2-1.5 5.2-1.8l5.1-1.8c.7-.2.7-.8.6-1.2-.6-3.4-.4-7 2.3-8.9.3-.3.3-1 .7-1.6 0 .3.6 1 .8 1.4a43 43 0 0 1 4.2 1.6l1.1.3c.2.1.5.3.6.6.2.4 0 .9-.2 1-.2 0-1.2-.3-1.5 0q0 .3.9.6c.2.2-.2.6-.4.6a.9.9 0 0 1-.6-.1z"
      />
      <Path
        strokeWidth={0.3}
      ...
      />
      <Path strokeWidth={0.2} d="M105.5 123.3c.8 0 1.5-.1 1.8-.9m5-17.4c0 1.7.7 2.2 2 2.4" />
      <Path
        strokeWidth={0.1}
      ...
      <Path
        fill="#fff"
        strokeWidth={0.1}
        d="M117.5 106.6c-.4.8-1.4 2.2-2.4 2.9a14 14 0 0 1-5 2.3h-1c-.4 0-.8-.3-1-.8-.2-.3-.2-1.6.3-1.8a3.7 3.7 0 0 1 1.6-.3c.2 0 .6.1.6.5 0 .3-.3.5-.6.4-.4 0-1-.3-1.3 0-.3 0-.4.7-.3 1 .3.4.5.5.8.6h.8c1.9-.5 3.4-1.3 4.8-2.3 1-.7 2-2.1 2.3-2.8zm-7.5 2.7c-.5-.2-1.5 0-1.5.2q.6-.3 1.5 0c.2 0 .3-.2 0-.2m3.7-4.7.3-.4c0-.1-.2-1.1.9-.6 1 .6.2 1 .1 1.1l-.2.5"
      />
      <Path strokeWidth={0.2} d="m112 103.7 5.9 3" />
      <G strokeWidth={0.2}>
        <Path
          fill="#fff"
          d="m104.5 104-4-.4c-.6 0-2 2-2.7 2.1-.8.2-1.5-1.5-2.6-1-.5.3 0 2.4-.3 2.6-.3.3-1.3-1-2-.6-.5.4.6 3.2.3 3.5s-1.6-1.2-2-1c-.5.3.4 4.6 0 4.8s-2.3-1.1-2.6-.6c-.2.6 2.7 2 3.5 2l.9-.3 2.8.3 1.4-1.3c2-2.7 4.3-5.3 7.3-5.1z"
        />
      ...
      <Path
        fill="#fff"
        strokeWidth={0.3}
        d="m113 138.8.3.5-.6.1-18.3-5.5c-.6-.1-.4-1 .2-.8zm-17.6-25.7c-.2-.4-.5-.7-.7-.7s-.6.4-.6.5c0 .2.6.6.8.7zm1.7.7-1.5 1.5c-.2.2.1.6.3.4l1.5-1.6c.2-.2-.1-.5-.3-.3m-.8 1.5 4.8 5h1l-.1-1-5-4.7z"
      />
      <Path strokeWidth={0.1} d="m101.4 119.7-4.7-4.8" />
      <Path
        fill="#fff"
        strokeWidth={0.3}
        d="M107.8 105.9c0-.3 0-.4.3-.6s.2 0 .4 0 .3.2.4.3h.3l.2-.5a.1.1 0 0 0 .1-.1l.2-.2.1-.3c.2 0 .4.2.4 0l.2-1c.4.1.2-.3.4-.4.4.2.5-.5.3-.7 0-.5.4-.6 1-.6 0-.3-.5-.4-.8-.9-.3-.4-1.3-1-2.4-1-1 0-2 1-2.4 1.5-.4.4-1.2.6-1.4.6-.3 0-.4-.3-.7-.3h-1c-.4 0-.5.3-1 .2a7 7 0 0 0-1.5.1c-.3.1 0 .8.3.8.2 0 1 0 1.2.2a3 3 0 0 0 1.7.1c.8-.3 1.3.3 2.2.5h.3c0 .5 0 .8-.2.8h-.8l-.8-.4c-.4-.1-.7 0-.8.1a24 24 0 0 0-5.2 4c-.4.8-1 1.2-1.6 2.4-.3.6-1 1.3-1.3 2.4-.7.2-1.3.8-1.4 1-.1.1 0 .4.2.4 0 0 .2.3.4.3-.1 0 .1.3.3.3-.1 0 0 .4.2.4l1.6-1.6c0-.6.3-1.3.5-1.7.9-1 2-2.6 2.2-3 .2-.3 2-1 2.4-1.5l.1 3 1 3c.2 1 0 1.7 0 2.2 0 .4.1.5.5.7s1.8 0 2.3.1c.9.3 1.6.3 2 .4a3 3 0 0 1 2.2.4c.3.3 1 1.8 1.2 2.4.3.6 1.7 1.4 2 1.8.2.3.5 1.2.4 1.6 0 .4 0 .6.4.6l1.8.3 1 .5 1.4.1c.4 0 .4-.7.2-.7a18 18 0 0 1-1.2-.3c-.5 0-1.4-.9-1.7-1.3-.4-.5-.6-1.1-.8-1.6a36 36 0 0 0-2-2.8l-1-2.3c-.1-.5-.5-.5-.8-.6-1.1-.3-1.5-.5-2.7-.7-.9-.2-1-.2-1.1-.8 0-.5-.4-1.4-.2-2l.2-1.2.3-1 .1-2zm.8 5.2a2 2 0 0 1-.9 0v-.3s-.1-.2 0-.2v-.6l.9-.1z"
      />
      <Path
        strokeWidth={0.3}
      ...
      <Path
        strokeWidth={0.1}
        d="M105.8 104.3c.6 2 .7 2.8 2.1 3m-2.6-3c.6 1.9 1.3 2.9 2.6 3m-3.1-3.3c.6 2 1.5 3.3 3.1 3.4m7.2 15.4c-.3-.2-.3-.3-.5-.8l-.5-1-.4.2s-.2-.2 0-.2l.2-.2-.4-.7c-.2 0 0-.1.2-.2.1 0 .3-.2.2 0l.4.7h.2c.2-.2.3 0 .2.2l-.3.1.5 1c.2.4.2.6.2 1m0-2.2-1.5.8m-1.4-1.1 2-1m-2.3.7 2-1m-18.5-4.2.6-.7m-1 .4.7-.6m-1 .3.7-.6m12.3-2.9h.7m-.7-.5h.6m-.6.3.6-.1m.8-5.7.4.2"
      />
    </G>
  </Svg>
);
