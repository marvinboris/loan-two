...
const SvgGs = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.9}
      d="M373.4 348.6s-2.3 6-3.6 6-6-2.5-6-2.5-3.5 5.5-5.3 5.8c-1.8.4-6.6-.8-6.6-.8s-4.5 0-4.7-.6c-.2-.7.2-2 .2-2s-6.6 5.2-8 4.9c-1.5-.3-6.4-6.5-6.4-6.5l-.8 3.2-9.3-.3-8.2-5.2s-4.6 7.5-4.8 7.3c-.1-.1-8 1.8-8 1.8l-.5-1.4-5.2-3.1s4-5.8 4-6l-1.9-.7-3 2.4-6 4-6-2.8 2.6-5 .3-3.6 4.8-7.1 58-56.4 28.6 52.8z"
    />
    <Path
      fill="#fff"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.9}
      d="m347.3 247.2 21.3-.4s14 0 15.5 4.6c2.7-6.1 14.9-5.7 14.9-5.7l22-.8.4 53.2a56.9 56.9 0 0 1-35.7 41.4 54.5 54.5 0 0 1-36.1-41.8z"
    />
    <Path
      fill="#006b00"
      stroke="#000"
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={0.5}
      d="M407 264.6c-1.7 1.4-12.5 4.1-12.6 13.5s1.9 11.6-.1 11.8c-4 0-4.5-10.5-4.4-15.1.1-4.7.2-4 .2-4s2.7.8 2.5 3c-.2 2.3 2.7-5.6 1.7-7.7 1.8 1.8 4.1 1 4.1 1 0-.2-1.3-1.6-1.9-2.7-.5-1 2 .6 2 .6s.1-1.8-2.1-1.7c-3 0 .5-1 .5-1s1.6 1.6 2.8 0c-1.3-1.4-3-2-3-2s-1.6-3-3.8-3.6c-2.4-.6-2 1-4.9.8-.5 1-.5 1.2.6 1.5-2 1.3-1 4-1 4s3.1-1.3 3 .8c-.1 2.2-1.8 1.8-3 .5-1-.6-1.3.6-1.3.6l1.6 1.6s-3 0-3.8 2a5 5 0 0 1 2.6.3s-3.5 1.6-3.8 2.4c-.4.8-.5-1-.6-1l-3.3-1.1-1.2 5.1s2.3 2.2 3.5 1.5 3.5-2.8 4.8-2.2c-3.9 3-7.8 7.2-10 7.8-.5-.4-2.4-2.4-3.2-1.4s-.2 2.1.8 2c1 0-3.2 1-2.3 2.8.8 1.8.7 1.6 1.5 1.2.8-.5-.7-.6 2.3-1.5 2.9-.8 2.8-1.6 2.8-1.6s-.6 1.3-2.2 1.6c-1.5.4-2.8.4-2.4.9.3.4 1 1.3.7 1.8-.2.4 3.3-2.5 4.2-.2 2.3 0 3.9-3 2.8-4.6 0 1.8 1.2 2.4.5 3.2-.6.8 5.3-2.7 2.4-4.9.8 1.8.9 3.2.9 3.2s1.3 0 1.7-.6c.3-.4-.7 1.4-.3 1.7.5.4 2.6 2.4 1.7 3.8-.5-.8-.7-2.1-1.3-2-.7.1-3.5 2.1-5.2 2.3-1.6 0 2 6.2 2 6.2s-2.5-.4-2.9-.2c-.3.3-2-2.1-2.3-.7-.6 1.8.5 1.1.5 1.1s-1.4-.7-2.2.1c-.8.9-1.6 1.7-1 2 .6.4 3 .4 3.4.3.3-.1-2.8.2-3 .6-.3.3-.7 1.7 0 2.1.6.5 2.3-.2 2.4-.6.1-.3.2 1.3.2 1.3s3 .3 3-2.7.2 2.1.2 2.1 2.9.5 3-2.5c0-3 .3 2 .3 2s2-.5 2-1-.2 6-1.5 7.8c-2.2-1.5-3.5.9-3.5.9s.1 3.5-.1 4.3 1.4-.5 1.5-.8c.2-.4 2.2-1.4 2.3-1.6l.6-1.4s-.4 1.6-1.2 1.9c-.8.2-1.5 1-1.2 1.8.3.7 1.6 1.2 2 1.9s2-4.2 2-4.2l.1 1s2-.4 2.3-1.3c.2-1-2.2-1.8-.3-3.4 2-1.5 0 1.4 0 1.4s.7 2.3 1.2 2.3c.4 0 1.5-4.3.4-5.4l1.7 1.4s1.6-4.5-.1-5l-2.5-.9s1-1.2.5-1.3 2.3 2.6 2.8 2c.4-.8 1-3-2.2-4.1-3.2-1.2 0-4.6 0-4.6s2 2.4 3.4 1.1-.1-1.3-.1-1.3 4.1-2.6 4.2-4l-2.1.2s2.3-1.6 1.8-4c-1 1.2-2.1 1.2-2.1 1.2s2-2 1.6-3.9c-1.2 1-1 1.7-1.9 1.4-.7-.2-2-7.7 1-8.2 3.2-.5 1.5 3.7 1.6 3.7s4.7-2 0-5c1.1-.4 3.5 1.8 3.5 1.8s-1-5.3-6-2c1.2-1.4 2-2.2 3-2 1 .3 4.5 0 4.5-1.1-.8-.8-2.7.3-3.8 0-1-.4 7.2-1 6.5-5z"
    />
    <Path
      fill="none"
      stroke="#006b00"
    ...
    <Path
      fill="#006b00"
      d="M389.2 267.3s2.4-1 2.8-1.5a7 7 0 0 0 1.5-2.1c.2-.7-1.6-1.8-.7-3.4.6-.7 1.4-.8 2.7 0 1.3.9-1.2-2.6-2.6-2.7-1.3-.1-2.2 1-2.5.7-.4-.2 0 1-.5 1s1.1 1 1 1.5c0 .6 1.8 2.6 1.7 3.1s-2.8 3.2-3.4 3.4"
    />
    <Path
      fill="#ffc900"
      stroke="#ffc900"
      ...
      strokeLinejoin="round"
      strokeWidth={0.5}
      d="M391 259.4c1-.3 1.1 0 1 1-.5-.3-.7-.5-1-1"
    />
    <Path
      fill="#e80000"
      stroke="#006b00"
    ...
    <Path
      fill="url(#gs_svg__d)"
      d="M371.8 262.1s4.8-1.3 7.3.7c2.6 2 2.6.2 2.6.2s3.7 1.4 4.8 1.1c1-.3-.8.1.7-.8s-3 .2-3.4-1.7c-.6-1.1.1-2.6-1.4-2.1-1.1-1.4.7-2.4.3-3.8-1.1.7-1.7-.3-2.6 1.6-2-.4-.3-3.2-2.5-3.5 0 2-1.7 2.2-1.8 3.3-1 .7-5.3 3.3-4 5"
    />
    <Path
      fill="#c01500"
      stroke="#000"
      strokeWidth={0.9}
      d="M316.4 418.8c3-.8 20 3.7 26.5 10.7-1.4-12.5-4.8-22-4.8-22s-10.1-2.9-11.5-1.5c-2 2.1-8.1 8.5-10.2 12.8zm-5.2-57.6c-1.2.2-2.4 1-3.6 3-1.4 3.3-2.3 11.8-4.3 13.8s-3.8 2.2-3.8 4 .2 6 5.6 7.5c5.3.2 13.8-8.5 13.8-8.5s4.4-4.8 6.1-9.9c-10.2 3.6-17.6-6-13.8-9.9zM460 416.8a46.8 46.8 0 0 0-26.8 10.6 108 108 0 0 1 4.8-21.8c1.2-.4 10-2.9 11.3-1.5 2 2.1 8.5 8.5 10.6 12.7zm4.7-57.2c1.2.2 1.6 1.7 2.6 3.7 1.3 3.3 2.7 8.2 4.7 10.2s3.7 4.8 3.7 6.6-.4 4.2-5.7 5.7c-5.3.2-13-6.6-13-6.6s-4.3-4.7-6-9.8c10.2 3.5 16.8-5.6 13.7-9.8z"
    />
    <Path
      fill="#fb0"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.9}
      d="M442 228.7s14.2.6 14.2 2c0 1.3-10.5 4-10.7 9.8-.1 5.9 8 6.3 8.6 13.6.6 7.4-6.3 8.5-7.7 10.5-1.4 1-4.8 11.3-4.3 17.5.4 6 2.2 26.8 5.4 31 2.5 1.9 6.2 8.1 10.3 6.2 4-2 1.2-9 .8-11s1.7-5.1 1.7-8c0-3-1.6-5.3-1.4-6 .1-.7 11.2 2.6 10.5 13.6s-5.1 7.6-5.1 7.6 1.4 13.5-2.1 15.3c-6.2 3.4-10.8-.7-10.8-.7l.6 2.8-4.8-2.5s-6.1-8.7-7.5-12.6a110 110 0 0 1-2.5-25c.6-3.8 1-25.7.7-26.9-.3-1-1.4-19.4-.7-22.2s5-15 4.9-15z"
    />
    <Path
      fill="#ff7000"
      stroke="#000"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M427.3 224.7s10.6-1.4 15-5.9" />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M438 221.8s7.8-.3 7.8.8" />
    <Path
      fill="#fff"
      stroke="#000"
      strokeLinejoin="round"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M423.3 174s10-5.4 15.6-9" />
    <Path
      fill="#00f"
      stroke="#000"
      strokeWidth={0.9}
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M338 218.4s3-5.1 9.8 1.4" />
    <Path
      fill="#fff"
      stroke="#000"
      strokeWidth={0.9}
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M323.4 165.8c3.8 3.9 13.5 5 18.5 9.3" />
    <Path
      fill="#cccccd"
      stroke="#ccc"
      strokeWidth={0.6}
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.9}
      d="M368.1 114s4.4-3.8 9.3-.3c-2.2 6.5-10 4-10 4s.2 3.3-.6 4.8c1.6 1.2 2.9 5.1 2.9 5.1s8-2 9.8 1.6c3-.4 5.3 0 5.3 0s6.2-1.6 8.4-1.6c2.3 0 9.3 1.8 10 3.1.6 1.3 3 10 4.5 10 1.6-.2-3.8 2-5.2-.2s-1 2.9-1 2.9 4.4 4.7 4.9 5.7-2.7 9.5-.3 15.4c-2.1.2-2.3 2.4-2.3 2.4-.1 2.6-3.4 3.3-3.4 3.3l-.8-3.5-2.2 1.3 1-2.8s3-7.2 3.2-9.6c.2-2.3-2.8-6.5-5.1-6.5s-4 7.4-4 7.4-1.2 5.6-.8 6.1l-1.6-1.8s-1 3.4-1.8 4.4-2.5 1.5-2.5 1.5-1.1-3.4-.8-4.7c.4-1.3 6.4-6.4 6-10-.6-3.7 0-2.8-.2-2.9s-3.1-2.7-3.3-4.2c-.1-1.4-3.9 1.9-8.8.8-1.5 2.7-1.7 9.3-1.7 9.3s-.5 7.9.5 8.8c1 1-2.6 2.9-2.6 2.9l-2.6 3.5-1-2-1.7 1.2 1-2.6c0-2 2.5-7.4 2.5-12 0-4.5.4-9.3.4-9.3s-4.9-.3-4.7 4.6c.1 5-1.2 5.3-1 6.7.3 1.4 1.6 5.4 1.2 6.6s-2 1.6-2 1.6l-.3.6s-4.8 2.2-4.7 3.2l-.1-2.6-.3-3.8s2.9-1.8 2.9-6.4-.7-5.2-.5-6.2c0-1 .7-4.9.6-5.3-.1-.3-2.7 1-3.5 1s1.4-2.6 1.7-4.6c.2-2-2.6 1.8-5-.4 1.1-2.4 2.8-3.1 3-5 .3-1.8-1.8 1.6-3.6.3.1-1.7 2-3.2 2-3.2s-1.5-.2-2.1 0c-1.2-.4 1.3-2.2 1.4-4.9.1-2.6-1.4-3.6-1.4-3.7 0-.2-2.6-2.4-3-3.3s-.4-2-.4-2-4.3 3.2-9.4-3.4c4.6-4 9.6-1 9.6-1s1.3-3.7 7.3-3.5c6 .3 7.2 3.7 7 3.3z"
    />
    <Path
      fill="#00f"
      stroke="#000"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M382.3 188.6v16.8m-12.9-36.6-7.9 12.9" />
    <Path
      fill="url(#gs_svg__f)"
      stroke="#000"
      strokeWidth={0.9}
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M396.4 167.8s-7.2 10.1-7 10.9" />
    <Path d="M359.4 119.3c-.1.6-1 .8-2 .5s-1.7-1-1.5-1.6 1-.8 2-.5 1.7 1 1.5 1.6m2.9-.3c.2.7 1.1.9 2.1.6s1.6-1 1.5-1.6c-.2-.6-1.1-.8-2-.5-1 .3-1.7 1-1.6 1.6z" />
    <Path
      fill="#ff7000"
      stroke="#000"
      strokeLinejoin="round"
      strokeWidth={0.9}
      d="M447 330.2s-2.8.5-2.7.8c.1.2-7.8.5-8 .2-.1-.2-1.1 1.4-1.1 1.4l1.2-.8s2 2 2.6 1.8c.5-.1-.3.8-.1 1 .1.1.7-.4.7-.4l13-.2zm4.8 4.1-10.7.3s-2.6 2.4-2.8 3 1.7.7 1.7.7l.6 2 1.4-.5s9 1.4 17.3-.5c4.2-1.4 5-3.2 2-4.3-3-1-9.5-.7-9.5-.7z"
    />
    <Path
      fill="url(#gs_svg__g)"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#2b2b2b"
      strokeWidth={0.9}
      d="M328.8 233.7s-1.4 4.3 0 6.5 10 19.8 10 19.8 6-7.3 8.2-7.5 1.2 19 1.2 19-3.6 3.3-5.8 3.1c-2.1-.2 5.4 7.5 5.2 14-.2 6.6-10 39-13.5 39.6s1.6-6 1.4-7.7c-.2-1.8-1.2-.6-2-2.6s1.2-5 .8-7c-.4-1.9-2.1-1.5-2.3-2.9s1.1-1.8 1-3.3c-.3-1.6-2.4-1.2-2.2-2.6s.4-.8.2-3.4c-.2-2.5-.6 1.8-2.8 2s-4 5.2-4 5.2-4.3 6-8.7 3.3c2.6 5.6.6 8-.4 8.1-1 .2.8 4.4-1.5 4.6-2.4.2 1.7 9.3-1 10 3 1.4.6 3.2.6 3.2s-6.9.6-5.4 9.5c-20.1-7.1-30-19.4-29.8-31.8.2-12.5 4.1-23.8 13.8-28 2.8-10.2 7.5-21.3 7.5-21.3s-.8-4.5-.2-7.5 3.4-6 3.4-6-.4-7-.2-10.6 1.6-5.1 1.8-7.1-.6-12 1.4-13.9c2-1.7 5.7-1.5 7.7-2.7s4.5-3.4 7-3.2c2.7.2 4.8 2 4.8 2s9.7 0 10.3 3.7c.6 3.8-2 5.2-2 5.2s1.4 5.3-4.5 10.3z"
    />
    <Path
      fill="#cecfcf"
      stroke="#2b2b2b"
    ...
    />
    <Path d="M318.5 221c0 .3-.3.6-.7.6s-.7-.3-.7-.6c0-.4.3-.7.7-.7s.7.3.7.7" />
    <Path
      fill="none"
      stroke="#2b2b2b"
      strokeWidth={0.4}
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="M333.9 219s-9.2 15-8 24.4" />
    <Path fill="none" stroke="#2b2b2b" strokeWidth={0.4} d="M334.5 218.6s-12.2 7.2-14.5 31" />
    <Path fill="none" stroke="#000" strokeWidth={0.9} d="m333.1 223-4.8 3.6" />
    <Path fill="none" stroke="#2b2b2b" strokeWidth={0.4} d="M315.5 251s6.8-28.3 18.8-32.4" />
    <Path
      fill="#2b2b2b"
      stroke="#2b2b2b"
      strokeWidth={0.9}
    ...
    />
    <Path d="M336.3 218.1c0 1-.6 1.6-1.4 1.6s-1.4-.7-1.4-1.6.6-1.6 1.4-1.6 1.4.7 1.4 1.6" />
    <Path
      fill="#2b2b2b"
      stroke="#2b2b2b"
      strokeWidth={0.9}
      d="M314.3 237.5s3 4.7 6.8 6c3.7 1.3-2.6 2.5-6.3 0-2.6-3.7-2-6.3-2-6.3s.8-.7 1.5.3zm26.4 28s-8.6-12-11.1-12.7 1.9-1.2 4.5 1.4c2.7 2.5-.7-4.2-.7-4.2z"
    />
    <Path
      fill="#2b2b2b"
      stroke="#2b2b2b"
