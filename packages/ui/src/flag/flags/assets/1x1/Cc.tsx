...
import Svg, { Defs, Path, Circle, G, Use } from 'react-native-svg';
...
const SvgCc = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      stroke="#7b3100"
      strokeWidth={1.4}
      d="M70.7 237.6h16s.8-1.5-.1-2.2c-.9-.8-4.3-1-3.4-3.5 2-5.4 2.2-3.7 3.4-16.4s1.7-32.6 1.7-32.6H86s.5 6.2-.9 14.3c-1.3 8-1.7 8.7-3.2 15-1.4 6.1-1.7 6.6-3 10.3-1.3 3.6-1.5 3.7-3.5 7l-2.5 4.2c-.6 1-1.3.7-1.7 1.4-.4.8-.5 2.5-.5 2.5z"
    />
    <Path
      fill="green"
    ...
    <G fill="#ffe000" transform="translate(-25.8 103.5)scale(.05833)">
      <Use xlinkHref="#cc_svg__a" width="100%" height="100%" x={7560} y={4200} />
      <Use xlinkHref="#cc_svg__a" width="100%" height="100%" x={6300} y={2205} />
      <Use xlinkHref="#cc_svg__a" width="100%" height="100%" x={7560} y={840} />
      <Use xlinkHref="#cc_svg__a" width="100%" height="100%" x={8680} y={1869} />
      <Use xlinkHref="#cc_svg__b" width="100%" height="100%" x={8064} y={2730} />
    </G>
  </Svg>
);
