  ...
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    <G strokeMiterlimit={4.8}>
      ...
      <G strokeMiterlimit={3}>
        ...
        <Path d="M397.5 298.7c0 1.8 1.3 3.5 3.8 5l.3-.4c-2.3-1.4-3.5-3-3.6-4.7 0-2.5 2.6-4.4 2.6-4.5l-.3-.4c-.1 0-3 2.1-2.8 5m52 .6c-.8 1.3-.5 2.8-.5 2.8h.5s-.2-1.4.5-2.5a3 3 0 0 1 2-1.2v-.5c-1.1.2-2 .7-2.5 1.4M330.3 276h-.2v.1s-.3 1.6-1 2a.8.8 0 0 1-.7.1l-1.2-.7c-.3-.3-.5-.4-.8-.3a1.8 1.8 0 0 1-.4-1.3q.15-1.2 1.5-2.1l-.1-.3c-1 .7-1.6 1.5-1.7 2.3-.1 1 .4 1.6.5 1.7h.1c.3-.1.4 0 .7.2l1.3.8h1c.7-.5 1-1.9 1-2.2 3.3.7 6-3.3 6-3.4l-.2-.2s-2.7 4-5.8 3.3" />
        <Path d="M322.5 275.4c-.2.6 0 1.3.3 1.9.4.6.7.9 1.1 1 .5 0 .8-.3 1.1-.6.2-.3.5-.5.6-.4l.3.2.3-.2-.5-.3c-.3 0-.6.2-.9.4-.3.3-.6.6-.9.5-.2 0-.5-.3-.8-.8a2.2 2.2 0 0 1-.3-1.7c.3-1.4 2-2.5 2-2.5v-.2c-.1 0-2 1-2.3 2.7M318 296c.2-.6.6-1 1.3-1.4-.1 0 .7.7 1.4.6l.4-.2c.2.1 1.4 1.2 1.4 2.6 0 .3 0 .6-.2.9l.3.1c1-2-1.3-4-1.3-4h-.2l-.5.3c-.5 0-1.2-.6-1.3-.6-.9.4-1.4 1-1.6 1.6zm10.4-5.3c-.7 0-2.6.4-3.2 1.3q-.3.6 0 1.2l.2.7c.6 1.5 1.2 3.1 1.8 3.5l.2-.3c-.6-.3-1.2-2-1.7-3.4l-.3-.6a1 1 0 0 1 0-.9c.6-.8 2.2-1.2 3-1.2.4 0 .5 1.5.6 2.5h.3c0-1.5-.2-2.9-1-2.8z" />
        ...
        <G transform="translate(-207.6 158.4)scale(.66486)">
          ...
          <Path d="M843.5 158h-.2l-2.4 3.3h.7a31 31 0 0 1 19.7 9.2l.3.3 2.3-2.5-.2-.3c-6.5-10.2-20.1-10-20.3-10zm.2.9c1.6 0 13.2.3 19.2 9.3l-1.3 1.4a33 33 0 0 0-19.3-8.9 631 631 0 0 1 1.4-1.8" />
          ...
          <Path d="M840.8 174.3a.3.3 0 0 1-.2.3.3.3 0 0 1 0-.6.3.3 0 0 1 .2.3m4.8-9.6s3.5 2.2.1 6.3c0 0 1.7-1.3 1.8-3.4.2-2.1-1.2-3.8-2-2.9zm13.5 5.9c-1.2.6-2.8-.5-3.6-1.5s-2.5-1.3-3.6.6c-1 1.8-2.5 2.5-2.5 2.5s1.5-.8 3-2.5c1.5-1.6 2.4-.3 3.9.5 1.4.8 1.7 1 2.7.5v-.1z" />
      ...
      <G fill="#00a651" stroke="#000" strokeWidth={0.8}>
        ...
        <Path
          strokeWidth={0.5}
          d="M345.9 329.8s-6.3-12-10.7-12.5c-4.3-.5-4.6-4.8-4.6-4.8s.5 2 4 2 10.3 5 11 8.7c.8 3.8 1.5 3.3 1.5 3.3z"
        />
        <Path
          strokeWidth={0.5}
          d="M345.9 329s2.3-15.2 12.2-15.5 6.6.8 9-.8c0 0-6.7 3.5-10.8 4s-7.5 8.5-7.4 10-2.2 4.4-3.4 3.4c-1.1-1 .4-1.1.4-1.1z"
        />
        <Path
          strokeWidth={0.5}
        ...
        <Path
          strokeWidth={0.5}
          d="M341 331s6 5.6 6.3 7.5c.4 1.9 1.7-5.6-1-7.8a13.8 13.8 0 0 0-5.8-2.5z"
        />
        <Path
          fill="#964b36"
          strokeWidth={0.5}
        ...
        />
        <Path strokeWidth={0.5} d="M327.7 332.9s-.2-5.8 3.5-8c0 0 .8.2 1.2-1 0 0-3 7.3-2.2 11v.5" />
        <Path strokeWidth={0.5} d="M328.5 325.8s6.8-14 15-9.1c0 0-8.6 1.7-11.7 7.9l-3.2 4.6z" />
        <Path
          strokeWidth={0.5}
        ...
        <Path
          strokeWidth={0.5}
          d="M362.3 328.8s-4.8-9.7-8-10.7c-3.3-1 1.8-2.5 3.8-.7 2 2 5.7 4.3 5.3 9.3l-1 2.1zm-4.9 13.4s1.4-6.6 5.2-8.6c3.7-2 7.2-1.3 7.2-1.3s-4.5 1-5.2 3.3c-.8 2.3-2 2.4-2 2.4z"
        />
        <Path
          fill="#964b36"
          strokeWidth={0.5}
      ...
      <G fill="#964b36" stroke="#000" strokeWidth={0.3}>
        <Path d="M431.4 360.6a1.1 1.1 0 0 0-.4.3zm9.2-2.3c0-.2-.1-.1-.2-.2l-.4-.8h-.3l-.7-1.4a.4.4 0 0 0 0-.2 8 8 0 0 0 0-.4c-.1-.1-.2 0-.3-.2v-.7l-.1-.4v-.6a2 2 0 0 0 0-.4c-.2-.4-.4-.7-.4-1.2l.1-1-.2-1 .2-.9v-5.3c-.2-.4-.1-.7-.2-1v-2l-.1 2.5c0-2.2-.2-4.3-.2-4.3l-3.3-1.5s-.3 6.1-.2 7c0 .8.3 6.7.2 7.4-.2.7-.5 4.2-.5 4.2s-1.6 1.2-2.3 2.5c-.6 1.2-.5 1.7-.7 1.7l1.6-.3-1.2.8a.7.7 0 0 1 .7.1l.3.2.2-.2.7.4.4-.3.2-.4h1.1c.3 0 .5-.4.8-.7.3-.2.5-.3.8-.3s.6.3.9.4c.2 0 .4 0 .6-.3l.3-.6h1.9l.3.2.1-.4v-.4z" />
        <Path d="m433.9 360.5.5.1.1.2a.2.2 0 0 0 .2 0l.3.1h.3l.4.1c.2.1.4 0 .6-.1.2-.2.3 0 .5.2s.2.1.3 0v-.1l.3-.1.4-.1.3-.2.4.2a.8.8 0 0 1 .2.1c.2-.3.6-.4.8-.6h1.3c.1-.1.1-.2.3-.2l.7.4c.1 0 .7.2.6-.3 0-.4-.4-.1-.5-.4v-.6a.7.7 0 0 0-.4-.4h-.3l-.2-.5c-.1 0-.2.1-.4 0l-.2-.2c-.3-.3-.5.2-.7.1-.2 0-.4-.5-.6-.7 0-.1-.3-.5-.4-.4-.2.1 0 .5-.1.7-.1.1-.4 0-.4 0-.2 0-.2 0-.3.3-.3.3-.4.6-.7.6l-.5-.2c-.1.1-.2.3-.4.3a1 1 0 0 1-.4 0c-.2 0-.3-.3-.4-.4a.1.1 0 0 0-.2 0l-.2-.1c-.2-.1-.2 0-.3.2v.5l-.4.4-.4.1c-.1 0-.3.3-.4 0-.1-.4.3-1.1-.2-1 0 0-.2 0-.3.3v.6c0 .3-.6.8-.5 1 0 .3.3 0 .4 0 .1.1 0 .3.2.4.1.3.7-.4.7 0m-2.1-2.7v-.1l-.5-.2-.4.4c-.3.5-.2 1-.7 1h-.4c-.2.1 0 .5 0 .7v.3c-.1 0-.2 0-.3.2 0 .4.3.3.4.3h1l.6-.2.5-.1a2.2 2.2 0 0 0 .2-.5v-.4c0-.2.2-.1.3-.4 0-.7-.7-.2-.6-.9" />
      </G>
      <G stroke="#000" strokeWidth={0.5}>
        <Path d="M440.2 338.7c0 1-.6 1.7-1.4 1.7s-1.4-.8-1.4-1.7.6-1.6 1.4-1.6 1.4.7 1.4 1.6zm-4.5-2c0 1-.7 1.6-1.4 1.6-.8 0-1.4-.7-1.4-1.6s.6-1.6 1.4-1.6c.7 0 1.4.7 1.4 1.6z" />
        <Path d="M438 337.3c0 1-.6 1.7-1.3 1.7-.8 0-1.4-.8-1.4-1.7s.6-1.6 1.4-1.6c.7 0 1.3.7 1.3 1.6z" />
        <Path d="M435.7 338.8c0 1-.6 1.7-1.3 1.7-.8 0-1.4-.8-1.4-1.7s.6-1.6 1.4-1.6c.7 0 1.3.7 1.3 1.6z" />
        <Path d="M437.9 340c0 1-.6 1.7-1.4 1.7s-1.4-.7-1.4-1.6c0-1 .6-1.7 1.4-1.7s1.4.8 1.4 1.7z" />
      </G>
      <Path
        fill="#00a651"
        stroke="#000"
      ...
      <Path
        ...
        stroke="#000"
        strokeWidth={0.5}
        d="M332 401s-2.4-1-3.5-.2c-1 .8-1 1.9-1.9 1.8 0 0 3.6.8 4.4-.1l1-1.2m.4.8s-1.6 2-1 3.2c.5 1.2 1.6 1.3 1.4 2.2 0 0 1.5-3.3.8-4.2l-1-1.2m-2.8-5.8s-2.5.8-2.8 2c-.3 1.4.6 2.1-.1 2.7 0 0 3.1-1.8 3.1-3a9 9 0 0 0-.1-1.5m1.3.7s1.2-2.3.4-3.4c-.7-1.1-1.9-1-1.7-2 0 0-1 3.6 0 4.4l1 1m-2.1-.9s0-2.5-1.1-3.2-2.1-.1-2.4-1c0 0 .6 3.6 1.8 4l1.5.3m4.4 4.2s2.7-.9 3 2c.1 3-.2 2-.2 2s-1.4-3.2-3-3.7z"
      />
      ...
      <Path
        ...
        stroke="#000"
        strokeWidth={0.7}
        d="M360.5 401.9c2-1.1 2.4-5.1 2.4-5.1-.4 1.4-4.1 2.9-4.1 2.9 2.7-1.7 6-9.4 6-9.4-.9 2.8-8 5-12.7 7.6-4.6 2.6-2.2 10-2.2 10a16 16 0 0 1-4.2-8.3c-.5-3.5-1.9-4.8-5-5.2-3.2-.4-5 3.1-5 3.1L331 400l4.7.2s3.4 1.1 3.4 3.8-3 13.3 2 19.3c3.4 4.1 16 6.5 16 6.5"
      />
      <Path
        fill="#fff"
        stroke="#000"
      ...
      <Path
        ...
        stroke="#000"
        strokeWidth={0.7}
        d="M358.4 417.3s4 6.8 4.5 10.4c0 0 7.7 8.6 10.6 9 0 0-1.3.6-3.8-1.5 0 0 2 2.2 2.5 2.3.4 0-1.7-.2-2-.8 0 0 .8 1.3 1.4 1.5l-.6-.2s-1-.1-1.5-.5-.2 1-.2 1-1.2-.3-1.6-.7.2.9.2.9l-1-.3-.8.5s0 .5-.6.1c-.4-.4-1.3 0-1.3 0s-.7.6-1 .2-1.5 1.5-1.5 1.5l-5.1-12.3"
      />
