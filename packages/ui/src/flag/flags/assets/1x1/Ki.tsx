...
const SvgKi = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <Defs>
      <ClipPath id="ki_svg__a">
        <Path fillOpacity={0.7} d="M161.8 5.8h491.7v491.6H161.8z" />
      </ClipPath>
    </Defs>
    <G clipPath="url(#ki_svg__a)" transform="translate(-168.5 -6)scale(1.0413)">
      <Path fill="#e73e2d" fillRule="evenodd" d="M4 5.8h802.6V300H4z" />
      <Path
        fill="#fec74a"
        fillRule="evenodd"
        stroke="#d8aa3f"
      ...
      />
      <Path fill="#005989" fillRule="evenodd" d="M3.2 297.1h806.6v200.3H3.2z" />
      <Path
        fill="#fff"
        fillRule="evenodd"
