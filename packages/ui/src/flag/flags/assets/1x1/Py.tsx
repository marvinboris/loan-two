...
const SvgPy = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    <G fill="#009b3a" stroke="#000" strokeWidth={0.1}>
      ...
      <Path d="m283.8 241.5-1.9.4c-.3 0-.6-.7-1.6-.5s-1.8.9-2 1.3c-.4.4 0 .8 1.2.6s1.6-1 2.2-1.1l2.1-.4 1.8-1.7c.5-.5 2-1 2.8-2 .7-.8.7-1.6 0-1.5a5 5 0 0 0-2.1 1.4c-.5.6-.4 1.5-1 2zm5.5 5.2a1.1 5.2 8.7 1 1-2.2-1 1.1 5.2 8.7 1 1 2.2 1z" />
      ...
      <Path d="M287 251.5h-2c-.3 0-.4-.8-1.4-.8s-2 .5-2.3.9c-.4.3 0 .8 1.1.8 1.2 0 1.8-.6 2.4-.7h2.1l2-1.3c.6-.4 2.3-.6 3.2-1.4.8-.6 1-1.5.3-1.4a5 5 0 0 0-2.4 1c-.6.4-.6 1.3-1.3 1.7l-1.8 1.2m2.7 6.7a1.1 5.2 31.3 0 1-1.6-1.8 1.1 5.2 31.3 0 1 1.6 1.8" />
      ...
      <Path d="M241.3 232a321 321 0 0 1 5.4-5.3l-6.5 3.7-.5 1.5h1.6" />
      ...
      <Path d="M238.6 233.5a499 499 0 0 1 5.3-7.4l-6.7 6-.3 1.9 1.6-.5" />
      ...
      <Path d="M229 245.6a634 634 0 0 1 3-11.1l-5 10.2.3 2.3 1.8-1.4" />
      ...
      <Path d="M231.2 266a602 602 0 0 1-5.7-10l3.6 11.3 1.9 1.2.2-2.4" />
