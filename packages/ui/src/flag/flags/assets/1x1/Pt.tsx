...
const SvgPt = (props: SvgProps) => (
  ...
  >
    ...
    >
      ...
      <Path
        strokeWidth={0.7}
        d="M204.8 152.8c56.5 0 103.1 46.5 103.1 103.2 0 56.8-46.6 103.2-103.1 103.2A103.6 103.6 0 0 1 101.5 256c0-56.7 46.6-103.2 103.2-103.2zM104 256c0 55.4 45.5 100.7 100.8 100.7 55.2 0 100.7-45.3 100.7-100.7S260 155.3 204.7 155.3 104 200.6 104 256"
      />
      <Path strokeWidth={0.7} d="M209.3 143h-9.7v226.4h9.7z" />
      <Path strokeWidth={0.7} d="M208.3 141.7h2.5v229h-2.5zm-9.6 0h2.5v229h-2.5z" />
      <Path
        strokeWidth={0.7}
    ...
    <G transform="translate(-68.3 28.4)scale(1.13778)">
      ...
      <G id="pt_svg__e">
        <G id="pt_svg__d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
          ...
          <Path d="M192 154c0-3.3 2.3-4.2 2.3-4.2s2.3 1 2.3 4.2H192m-5.8-9h16.3c.3 0 .6.4.6.8 0 .3-.3.6-.6.6h-16.3c-.3 0-.6-.3-.6-.7 0-.3.3-.6.6-.6zm.4 1.5H202c.3 0 .6.3.6.7s-.3.7-.6.7h-15.5c-.4 0-.6-.3-.6-.7s.2-.7.6-.7zm5-10.6h1.2v.8h.9v-.8h1.3v.9h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.4c-.3 0-.6-.2-.6-.5zm4.6 2.7.3 6.4h-4.3l.3-6.5h3.7" />
      ...
      <Use xlinkHref="#pt_svg__e" width="100%" height="100%" transform="matrix(-1 0 0 1 479.8 0)" />
