...
import Svg, { Defs, LinearGradient, Stop, ClipPath, Path, G, Use } from 'react-native-svg';
  ...
  >
    ...
    <G clipPath="url(#ni_svg__c)" transform="translate(-170.7)scale(.85333)">
      ...
      <G id="ni_svg__e">
        ...
        <Use xlinkHref="#ni_svg__d" width="100%" height="100%" transform="rotate(72 500 285.5)" />
        <Use xlinkHref="#ni_svg__d" width="100%" height="100%" transform="rotate(144 500 285.5)" />
        <Use xlinkHref="#ni_svg__d" width="100%" height="100%" transform="rotate(-144 500 285.5)" />
        <Use xlinkHref="#ni_svg__d" width="100%" height="100%" transform="rotate(-72 500 285.5)" />
      </G>
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(8 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(16 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(24 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(32 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(40 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(48 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(56 500 285.5)" />
      <Use xlinkHref="#ni_svg__e" width="100%" height="100%" transform="rotate(64 500 285.5)" />
      <Path
        fill="red"
      ...
      <G fill="url(#ni_svg__h)">
        ...
        <G id="ni_svg__n" fill="url(#ni_svg__i)">
          ...
          />
          <Use xlinkHref="#ni_svg__k" width="100%" height="100%" y={-1.1} fill="url(#ni_svg__l)" />
          <Use xlinkHref="#ni_svg__k" width="100%" height="100%" y={-2.2} fill="url(#ni_svg__m)" />
        </G>
        <Use xlinkHref="#ni_svg__n" width="100%" height="100%" y={-3.3} fill="url(#ni_svg__o)" />
        <Use xlinkHref="#ni_svg__n" width="100%" height="100%" y={-6.7} fill="url(#ni_svg__p)" />
        <Path
          fill="url(#ni_svg__q)"
        ...
        />
        <Path fill="url(#ni_svg__r)" d="M457.4 312.3c3.4.7 3.7 0 3.7 0zm81.5 0s.3.7 3.7 0z" />
      </G>
      <G fill="#ccd11e">
        <G id="ni_svg__t">
          <Path
        ...
        <Use xlinkHref="#ni_svg__w" width="100%" height="100%" x={-15.4} fill="#c6cb24" />
      </G>
      <Path
        fill="#fff"
      ...
      />
      <Path fill="#fff" d="m550 324.6 4 .3a91 91 0 0 0 2.9.3l-.4-.5c-.6.2-4.4-.2-6.4 0z" />
    </G>
    <Path
      fill="#c8a400"
