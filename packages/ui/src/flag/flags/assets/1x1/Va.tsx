...
const SvgVa = (props: SvgProps) => (
  ...
  >
    ...
    <G stroke="#000" strokeLinejoin="round" strokeWidth={3.2}>
      <G fill="#ce9d09" strokeLinecap="round" transform="scale(.2048)">
        <G id="va_svg__a">
          <Path
            fill="#fff"
      ...
      <G fill="#fa0204" transform="scale(.2048)">
        ...
        />
        <Use xlinkHref="#va_svg__d" width="100%" height="100%" x={6.4} y={14.3} />
        ...
        />
        <Use xlinkHref="#va_svg__f" width="100%" height="100%" x={14} y={10.7} />
        ...
        />
        <Use xlinkHref="#va_svg__g" width="100%" height="100%" x={12.8} y={10.4} />
        <Path
          id="va_svg__h"
          d="M1929.3 1250.9c-3.3 2.8-9.7.3-12.6-2.9-3.1-3.3-5.3-10.5-1.8-13.5 3.4-3 10.2.2 13.2 3.6 2.7 3.3 4.4 10 1.2 12.8z"
        />
        <Use xlinkHref="#va_svg__h" width="100%" height="100%" x={-7} y={12.8} />
        <Use xlinkHref="#va_svg__h" width="100%" height="100%" x={-19.5} y={23.5} />
        ...
        />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={-7.3} y={13.8} />
        <Path
          id="va_svg__j"
          d="M1820.8 1339.5c-4.3 1.8-4.8 10.2-3 15.3 1.8 5.3 7.9 11.9 12.5 10 4.6-1.8 4.7-11 2.6-16.3-2-4.9-7.8-10.7-12-9z"
        />
        <Use xlinkHref="#va_svg__j" width="100%" height="100%" x={-10.5} y={14.9} />
        <Path
          id="va_svg__k"
          d="M1802.7 1371c-4.6 1-6.5 9.3-5.5 14.6 1 5.5 6 13 10.8 11.9s6.4-10.2 5.2-15.7c-1.2-5.1-6-11.8-10.5-10.8z"
        />
        <Use xlinkHref="#va_svg__k" width="100%" height="100%" x={-10.1} y={15.9} />
        <Path
          id="va_svg__l"
          d="M1784 1403.3c-4.6.2-8 8-8 13.3 0 5.6 3.5 13.9 8.4 13.7 5-.2 8.2-8.8 8-14.5-.2-5.3-3.7-12.7-8.3-12.5z"
        />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-10.3} y={19.2} />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-22.4} y={37} />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-34.9} y={52.3} />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-47.8} y={66.5} />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-62} y={78.1} />
        <Use xlinkHref="#va_svg__l" width="100%" height="100%" x={-75.6} y={90.6} />
        ...
        />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-13.4} y={-13.7} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-25.9} y={-29.2} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-38.7} y={-42.3} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-49} y={-60.3} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-60.3} y={-76.4} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-70.6} y={-93.5} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-79.8} y={-113.3} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-89.8} y={-131.2} />
        <Use xlinkHref="#va_svg__m" width="100%" height="100%" x={-98} y={-152.5} />
        ...
        />
        <Use xlinkHref="#va_svg__n" width="100%" height="100%" x={18.3} y={-2.2} />
        <Use xlinkHref="#va_svg__n" width="100%" height="100%" x={36.8} y={-5.8} />
        <Path
          id="va_svg__o"
          d="M1916.2 1603.8c-2.3 4 2.6 11 7.1 13.8 4.8 3 13.7 4.3 16 0 2.5-4.4-3.2-11.6-8.1-14.4-4.6-2.6-12.8-3.4-15 .6z"
        />
        <Use xlinkHref="#va_svg__o" width="100%" height="100%" x={20} y={-3.2} />
        <Path
          id="va_svg__p"
          d="M1953.5 1595.4c-2 4.3 3.6 10.7 8.4 13.1 5 2.5 14 3 16-1.5s-4.4-11.2-9.5-13.5c-4.8-2.2-13-2.3-15 2z"
        />
        <Use xlinkHref="#va_svg__p" width="100%" height="100%" x={18.9} y={-5.6} />
        <Path
          id="va_svg__q"
          d="M1991.3 1583.9c-1.7 4.4 4.2 10.5 9.1 12.5 5.2 2.2 14.2 2.2 15.9-2.4 1.7-4.7-5-11-10.3-13-5-1.8-13.1-1.4-14.7 2.9z"
        />
        <Use xlinkHref="#va_svg__q" width="100%" height="100%" x={19.2} y={-6.2} />
        <Use xlinkHref="#va_svg__q" width="100%" height="100%" x={37.7} y={-14} />
        <Use xlinkHref="#va_svg__q" width="100%" height="100%" x={57.5} y={-22.2} />
        <Use xlinkHref="#va_svg__q" width="100%" height="100%" x={77.5} y={-28.6} />
        <Use xlinkHref="#va_svg__q" width="100%" height="100%" x={79.9} y={-44.3} />
        ...
        />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={18.9} y={7.8} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={37} y={10.6} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={56.8} y={15.5} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={74.7} y={18.1} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={92.3} y={21.7} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={110.4} y={26.7} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={128.3} y={29.9} />
        <Use xlinkHref="#va_svg__r" width="100%" height="100%" x={146.6} y={32.7} />
        ...
        />
        <Use xlinkHref="#va_svg__s" width="100%" height="100%" x={16.8} y={6.2} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={8.6} y={-11.2} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.7} y={6.5} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.9} y={26.7} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.7} y={47.9} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={5.6} y={68.6} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={2.2} y={87.7} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.7} y={109.1} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={2.2} y={126.4} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.7} y={143.5} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.7} y={163.9} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={3.4} y={183.9} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={3.7} y={203.1} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.4} y={223.5} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={4.4} y={243.3} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={3.7} y={263.1} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={2.5} y={283.2} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={2.5} y={305.1} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={1.9} y={327.9} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={1.9} y={349.3} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={1.9} y={369} />
        <Use xlinkHref="#va_svg__i" width="100%" height="100%" x={1.3} y={391.3} />
        <Path
          id="va_svg__t"
          d="M1882.2 1303.2c2.5 3.7-1.3 10.8-5.1 14-4 3.2-12 5.4-14.5 1.5-2.6-4 1.9-11.4 6-14.6 4-3 11.2-4.6 13.6-1z"
        />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={2.7} y={16.1} />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={2.4} y={34.1} />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={2.1} y={52.4} />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={1.8} y={69.1} />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={2.7} y={87.1} />
        <Use xlinkHref="#va_svg__t" width="100%" height="100%" x={1.5} y={104.4} />
        ...
        />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.6} y={20.4} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.9} y={40.5} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.3} y={62.1} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.9} y={82.2} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.3} y={102.6} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.6} y={123} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.6} y={143.7} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={-0.3} y={164.4} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.9} y={183.3} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.9} y={203.1} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.3} y={224.4} />
        <Use xlinkHref="#va_svg__u" width="100%" height="100%" x={0.3} y={245.4} />
      </G>
