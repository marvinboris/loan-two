...
const SvgDg = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m402.3 235-24-13.9-4.9 22.2" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m408.7 247-24-13.9-5 22.1" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M413.4 256 391 245l-6.5 19.1" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m418.2 265-22.4-11-6.5 19.2" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M419.3 275 399 260l-1.4 21.1" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M329.8 180.6 361 183l-9.4-24.6" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m316.3 171.7 31.2 2.3-9.5-24.6" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M306.1 165h27.8l-6-22.4" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M296 158.2h27.8l-6.1-22.3" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m288.5 148.6 28.5 5.2-12.2-21.9" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m422 169-16 23 30 3.3" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m437.3 162.4-16 23.1 30 3.3" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m448.8 157.4-12.2 21.5 26.1 5" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M460.3 152.4 448 174l26 5" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m473.5 150.8-17.8 19.8H484" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M439.3 219.8H408l12 23.8" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m453.8 227.6-31.3.2 12 23.7" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m464.7 233.5-27.8 2.1 8.5 21.8" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m475.5 239.4-27.7 2.1 8.4 21.8" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m484 248.3-29-2.8 14.5 20.8" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m352 242.8 6.7-24.2-25.8 3.7" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m341.1 252 6.9-24-25.9 3.7" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m333 259 4-21.8-23.1 1.4" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m324.8 266 4-21.9-23 1.5" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m314.3 270.4 9.1-21.6-23.4 6.3" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="M451.7 115 428 135.3 382.2 195" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m418 170-26.2 12.4-2.2-19" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m428 157.6-26.5 12.3-2.2-19" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m437.4 145-26.3 12.3-2-19" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m445.3 135.7-24.5 9-2.9-15.4" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m454.3 126.7-26.3 8.7-1-15.1" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m457.8 118.2-24.3 12.5 4.7-18.9" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m371.2 96.4 7.8 28 2.9 71.4" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m366.5 158.5 14.8 22.3 13.4-15.3" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m365.5 143.4 15.2 22.3 13.4-15.2" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m365.1 128.4 15 22.3 13.2-15.3" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m364 117 15.5 18.7 11.8-12" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m361.8 105.3 17.2 19.1 10-12.4" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m364 96.4 13.2 21.6 7.4-18.3" />
    <Path
      fill="#006d00"
      fillRule="evenodd"
      stroke="#fff"
    ...
    />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m352 210.4 17-10.4-17.3-13.5" />
    <Path fill="none" stroke="#000" strokeWidth={0.3} d="m333 208.8 20.9-11.1-17.2-13.5" />
    <Path
      fill="none"
      stroke="#000"
      strokeWidth={0.3}
    ...
    <G fillRule="evenodd">
      ...
      <Path
        fill="#c00"
        d="M346 368.9c0 1.3-.8 2.3-2 2.3s-2.1-1-2.1-2.3.9-2.3 2-2.3c1.2 0 2.2 1 2.2 2.3zm79.8 0c0 1.3-1 2.3-2.2 2.3-1.1 0-2-1-2-2.3s.9-2.3 2-2.3c1.2 0 2.1 1 2.1 2.3z"
      />
