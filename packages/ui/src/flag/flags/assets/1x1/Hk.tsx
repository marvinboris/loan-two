...
const SvgHk = (props: SvgProps) => (
  ...
  >
    ...
    />
    <Use xlinkHref="#hk_svg__a" transform="rotate(72 248.5 259.5)" />
    <Use xlinkHref="#hk_svg__a" transform="rotate(144 248.5 259.5)" />
    <Use xlinkHref="#hk_svg__a" transform="rotate(216 248.5 259.5)" />
    <Use xlinkHref="#hk_svg__a" transform="rotate(288 248.5 259.5)" />
  </Svg>
);
