...
const SvgMz = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    <G clipPath="url(#mz_svg__a)" transform="scale(1.0321)">
      <Path fill="#009a00" fillRule="evenodd" d="M0 0h744v155H0z" />
      <Path fill="#fff" fillRule="evenodd" d="M0 155h744v15.5H0z" />
      <Path fill="#000001" fillRule="evenodd" d="M0 170.5h744v155H0z" />
      <Path fill="#fff" fillRule="evenodd" d="M0 325.5h744V341H0z" />
      <Path fill="#ffca00" fillRule="evenodd" d="M0 341h744v155H0z" />
      <Path fill="red" fillRule="evenodd" d="M0 0v496l325.6-248z" />
      <Path
        fill="#ffca00"
        fillRule="evenodd"
      ...
      />
      <Path fill="none" stroke="#000" strokeWidth={1.1} d="m143.4 238.9-.3 37.6m30.7-37 6.4 29.8" />
      <Path
        fill="none"
        stroke="#000"
        strokeLinecap="round"
