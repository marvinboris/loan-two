...
const SvgEsGa = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <G fontSize={12}>
      <Path fill="#fff" fillRule="evenodd" d="M0-.1h512v512H0z" />
    ...
    <G fontSize={12}>
      ...
      <Path
        fill="#fc0"
        d="M287.5 141.9s-6.5-.8-10.4.7a16.6 16.6 0 0 1 1.4 18.2c-1 1.7-2 5-1.5 7.6h-1.2s-1.3-5.4.8-8.4a11.4 11.4 0 0 0 1-11.6 14.3 14.3 0 0 0-5-6.2c-3.6 1.5-11 0-13.1-1.5-2-1.5-3.2-3.5.8-3.7 3.8-.3 10.5-.1 15 3.4 0 0 2.4-2.9 14.4-1.5 11.9 1.3 20.5 6.4 23.1 17 1.4 5.6-3.6 17-8.3 19.8 0 0 0-1.8-.3-3.2 0 0 8-8.9 5.6-17.2s-12-13.7-22.3-13.4"
      />
      <Path
        fill="#bcac0b"
        stroke="#000"
      ...
      <Path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <Path fill="#058e6e" fillOpacity={0.9} d="M232.6 190.8s-7.3.7-9 1.4v4.3s4.8-.8 9.1-1.1z" />
      <Path
        fill="none"
        stroke="#000"
        strokeWidth={0.5}
