  ...
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    ...
    <G clipPath="url(#pf_svg__a)">
      ...
      <Path
        ...
        stroke="#083d9c"
        strokeWidth="2pt"
        d="M210.4 363.5s11.6-9.4 22.8-9.4 14.4 7.8 22.2 8.4c7.8.7 14.4-7.8 24-8 9.8-.4 22 6.8 22 6.8L258.9 374l-48.5-10.6zm-24.3-13.8 144.3.7s-12.5-13.5-27.2-13.8c-14.6-.3-10.6 6.3-21.8 7.2-11.3 1-14.1-6.9-24.4-6.6s-16.3 6.6-24 6.9c-7.9.3-17.9-7.8-23.8-7.5-6 .3-27.2 9.4-27.2 9.4zm-18.5-17.2 178.1.7c2.9-4.1-8.7-13.8-19.3-14.7-8.8.3-15 9-22.2 9.3-7.2.4-15.3-9-23.5-8.7-8 .3-16.5 8.8-24.6 8.8-8.2 0-14.1-9.1-24.4-9.1s-15 10-22.8 9.4c-7.9-.7-14.7-10-22.2-10s-20 11.2-22.5 10.6 3.1 4.7 3.4 3.7z"
      />
      <Path
        fill="red"
        fillRule="evenodd"
      ...
      />
      <Path fill="#de2010" fillRule="evenodd" d="M-128 384h768v128h-768zm0-384h768v128h-768z" />
    </G>
  </Svg>
);
