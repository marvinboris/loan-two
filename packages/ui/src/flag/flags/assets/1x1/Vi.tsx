...
const SvgVi = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.2}
      d="M163.5 316s-.4-2.9 4.9-5c5.3-2 5.7-9.7 4.7-14.8 0 0-2.8 4.9-6.2 6.5 0 0-5.5 2.9-5.8 8.4 0 0 0 2-.4 3.5-.2.9-2.7-6.8 2-12.6 4.7-5.9 6-10.7 2.3-20 0 0-.4 5.6-4.1 8.9-3.8 3.2-4.2 3.5-4.2 11.2 0 0 0 2.7-1.3 3.6 0 0-3-4.3-3.7-7-.8-2.9-1.1-4 2.2-7.3 0 0 10.6-6.9 3-22 0 0-.3 5.3-4 8.3-3.6 3-3.3 5.1-3.5 10.4s-.6 5-1 5.7c0 0-6.7-12.4-1.5-19s8.1-8 2.4-20.3c0 0 .2 6.3-4.4 9.4s-3.5 10.5-3.5 10.5.3 2.7-.7 4.7c0 0-6.5-12.7-.3-19.5 5.3-5.8 5.7-9.9 2.8-18.1 0 0-.3 3.8-3.2 5.9-3 2-5.2 4-4.7 12 0 0 .2 5.5-.5 7 0 0-2.7-5-3.5-8.3-.7-3.3-1-5.2 1-8.5s10-12.8.4-26.4c0 0-.3 4.4-2.7 8.4s-1.3 8.7-.8 12.3c.6 3.6-1.2 7.1-1.2 7.1s-4.1-7.6-3.3-16.3c1-8.7-2.6-16-10.7-21 0 0-5.8 13.5 2.2 20.4 0 0 6.8 6.8 8.5 15 0 0-5.2-.6-9.8-9.7-4.7-9-14.4-7.6-15-7.7 0 0 1.5 14 16.4 18 0 0 9.6 1.7 11.3 8.7 0 0 1.6 4.8 2.3 7.4 0 0-3-1.2-5.8-5.3-2.8-4.2-2.4-4.7-11.8-5.6 0 0-3.8-.4-5.8-3.1 0 0 4 14.9 14.1 14.8 0 0 9.3-1 14.5 11.2l-2.4-1.6c-1.3-1-4.8-2.7-11.6-1.8s-8.7-.4-10.4-1c0 0 6.9 12.7 16.6 9 9.7-3.8 14.4 9.8 14.5 10.1 0 0-1.3-1-3-2.7s-5.3-3.7-12-1.6c0 0-4.9 1.9-9.8.4 0 0 4.7 9.1 15.8 7.6 11-1.6 13.9 8.2 13.9 8.2l-2.5-1.7c-1-.8-4.8-3-12.8-.6s-10.9-.4-10.9-.4 4.5 8.1 13 9c0 0 4.7 0 6.8-.7a9 9 0 0 1 11 3.3s-1 .2-2.6-.5c0 0-5.7-2-10 1.6 0 0-3.8 4-9.3 3.2 0 0 7 6.8 18.3 1 0 0 3.8-2.7 6.5-.6 2.8 2.1 9.3-2 9.3-2z"
    />
    <G fill="#f4c53d" stroke="#010002" strokeMiterlimit={10} strokeWidth={1.2}>
      ...
      <Path d="M291 175.7c-1.4 1.8-6.9 2.4-6.9 2.4s5.7 4.3 8.1 10.6c2.5 6.2-65.8 0-65.8 0s3-2.1 5-6c0 0-3 1-6.1-2 0 0 2.3.8 5.2-3.7 0 0 4.4-5.6 7.5-7.1 0 0-1.5.9-4.9-1 0 0 6-.8 8-10.9 0 0 .4-2.2 2.7-5.5 2.2-3.2 1.7.7 5.9-4.3 0 0 1.9-3.6.2-5.7s-3.4-1.4-6.9-3.5-5-3.2-3.8-6.4 4.2-2.7 4.7-2.7c.4 0 .7-2.8 4.4-4.7a29 29 0 0 1 15.4-.3c1.5.9 7.6 2.7 11.1 11.6 3.6 9-1 12.4 8.8 26 0 0-4 .8-6.4 0 0 0 5 9 13.8 13.2z" />
      <Path fill="none" d="M248.7 137.8c-7.8-.4-4.8-7.9-4.8-7.9" />
      <Path d="M262.4 138.8s-1.4-.7-2.5-2.2c-1.7-2.2-5.4-3.2-7.4-1.2 0 0-2 2.3-3.8 2.4 0 0 2 .6 3.4 1.9s2.9 2.2 5 2c2-.4 2.4-1.5 3.3-2.1 1-.7 2-.8 2-.8z" />
    </G>
    <Path
      fill="#369443"
      stroke="#010002"
    ...
    <Path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.2}
      d="m358.6 331.1-12.1 15.4 2.8 8.6-24.7 28.9-2.3-13.3-12.8-1 24.7-28.9 8.3 2 12.8-16.2s3.5 1.7 3.3 4.5zm-306.2-36c2.9-1.2 5-2.3 5-5.4 0-.7-.4-2.3-1.3-4.8l-19.3-59.1a51 51 0 0 0-2.4-6.4c-.9-1.7-2.6-2.4-4.9-3.3h24.6c-2.7 1.2-5.1 2.2-5 5 0 1.2.2 2.7.8 4.7L64.8 272l14.8-46.3c.6-2 1-3.5 1-4.6-.1-3-2.7-4-5.2-5.1h23.9c-2.2.9-4 1.5-4.9 3.3-.4.8-1.3 2.8-2.4 6.4l-19.3 59a30 30 0 0 0-1.3 5s-.9 3.7 5 5.3zm412.2-6v-67a5.1 5.1 0 0 0-.6-2.6c-.3-.7-2-2.4-4.4-3.4h22.2a9.2 9.2 0 0 0-4.4 3.3 5.3 5.3 0 0 0-.6 2.7v67q0 1.65.6 2.7c.4.6 2 2.2 4.4 3.3h-22.2c2.4-1 4-2.7 4.4-3.3.4-.7.6-1.6.6-2.8z"
    />
    <Path
      fill="#fff"
      stroke="#010002"
