...
const SvgMo = (props: SvgProps) => (
  ...
  >
    ...
    <Use xlinkHref="#mo_svg__a" width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)" />
  </Svg>
);
