...
const SvgFk = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      stroke="#fff"
      strokeWidth={10}
      d="M671 321.6a13 13 0 0 0-2 .1c-3.4.6-8.8 11.7-11.7 18.2-4.7 5.6-7.1 10-9 13.2-.8 1.3-2 2.7-1.6 4.4-7 1.7-7.4 7.7-7.4 10 0 2.6.8 3.8.8 3.8l4.2 7.8v.1c4.5 9.3 11 21.7 14.8 22.7 5.2 1.5 18.8-3.5 29-12.2a164 164 0 0 0 62 12.6c23.8 0 45.2-5.7 61.9-12.6 10.2 8.7 23.7 13.7 29 12.2 3.7-1 10.3-13.5 14.8-22.7l4.1-7.9s.8-1.2.8-3.7c0-2.3-.4-8.4-7.4-10 .4-1.7-.7-3.2-1.5-4.5-2-3.3-4.4-7.7-9-13.4-3-6.5-8.4-17.4-11.7-18-4.8-.8-15 1.6-15 2.5v.5L795.4 344c0 .5 1 14.5 5 27a147 147 0 0 1-50.5 8.5c-19.8 0-36.7-3.5-50.4-8.6a136 136 0 0 0 5-27L684 324.7v-.5c0-.7-7.9-2.6-13-2.6zm5.2 24c2.6 0 5.3 2.2 7.6 4.5l-.2 1.4a79 79 0 0 1-3.2 10.6 85.8 85.8 0 0 1-14.3-10.3c2.2-2.4 5.8-5.6 9.6-6.1zm147.6 0h.5c3.8.6 7.4 3.8 9.7 6.2a85.6 85.6 0 0 1-14.4 10.3 78 78 0 0 1-3.2-10.6 17 17 0 0 1-.2-1.4c2.2-2.4 5-4.5 7.6-4.5zm-166 27.4c2.7 2.1 6.3 4.5 10.6 7a12.3 12.3 0 0 1-3.8 1.7c-1.8.4-3.6.3-5.5-.1a17.5 17.5 0 0 1-1.2-5.7 70 70 0 0 1-.1-2.9zm184.5 0-.2 2.9a17.6 17.6 0 0 1-1.2 5.7 12 12 0 0 1-9.3-1.6c4.4-2.5 8-4.9 10.7-7z"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={1.2}
      d="M445.6 595.5s5.7-8.8 10.3-8.1c4.7.6 9.1 6.2 9.4 6.5a41 41 0 0 0 6.9-7.5c-.3-.3-7.2-16.5-11-17.2a24.7 24.7 0 0 0-11.8 1.8z"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={1.2}
      d="M433.1 586.1c0 .6 2 23.8 10 31.9s21.3 13.1 26 11.9c4.6-1.3 15.3-24.7 15.3-24.7s-11.3 11.2-19.7 9.3c-8.4-1.8-13.4-15.9-15-22.8-1.6-6.8-.3-20.3-.3-20.3L433 586.1z"
      transform="matrix(-1.204 0 0 1.26 868.6 -393.2)"
    />
    <Path
      fill="url(#fk_svg__e)"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={1.5}
      d="M656.4 338.6c-4.7 5.7-7.2 10.2-9.2 13.5s-.8 8 3.7 14.5c5 7 45.4 34.7 98.1 34.7s93.1-27.6 98-34.7c4.6-6.6 5.8-11.2 3.8-14.5s-4.5-7.8-9.2-13.5c0 8.6-33.5 40-92.6 40s-92.6-31.4-92.6-40z"
    ...
    <G fillRule="evenodd">
      ...
      <Path
        fill="#bcbcbc"
        d="M338 125.9v.3c0-.8 0-.4.3 1 .4 1 .5 2 .5 3.5a5.5 5.5 0 0 0 1.7-2.5c0-2.2-.4-2.2-2.5-2.3m9.8 32h.3c-.8 0-.3 0 1-.8 1-.7 1.7-1.6 3-2a10.6 10.6 0 0 1 3.4-2c.7-.3 1.3-.7 2-.3-.2 1.4-.5 2-1.7 2.6-.6.8-1.5 1.3-2.4 1.6-.8.4-1.8.5-2.1 1.5-1.5.6-1.6.5-3.4-.6zm5.1 8 3-2.7a12.2 12.2 0 0 1 2.6-2.8c.8-1.2 1.8-2 2.4-3l2.1-2.8c0 1.2-.1 2.8.3 3.5a5.7 5.7 0 0 1-.8 3.4c-.6 1-1 1.6-2.5 2.3-1.1.6-1.9.8-2.8 1.6a21 21 0 0 1-2.5 1.4c-.7.3-.4.2-1.8-.8zm-8.3 6.4h.3c-.8 0-.4.1 1.1-.8 1.1-1.1 2-1.6 3.4-2.2a8.4 8.4 0 0 0 3.3-.8c.6-.2 1-.6 1.5 0 .9 1.1 1.1 1.5-.2 2.2a7.7 7.7 0 0 1-2.7 1.4c-.6.6-2 .6-3.3.8-1 0-1.6.2-2-.6l2.1.6c-1 0-1.6.2-3.5-.6m11.4 0v-.2c0 .8 0 .4.6-1.2 1-1.5 1.4-2.4 2.7-2.7.6-.8 1.6-1 3-1.4.4.8 0 1.8 0 2.8-.4 1-1.4 1.7-2 2.5-.8.6-1 1.1-2.4 1.4-1 0-.4 0-1.8-1.2z"
      />
      <Path d="M330 136.2c0 .8-.5 1.4-1.3 1.4s-1.4-.6-1.4-1.4.7-1.4 1.4-1.4c.8 0 1.3.6 1.3 1.4" />
    </G>
    ...
    <G transform="matrix(.96 0 0 .96 -338.1 20.2)">
      ...
      <Path
        ...
        transform="matrix(1.255 0 0 1.312 259.4 -430)"
      />
      <Use xlinkHref="#fk_svg__l" width={992.1} height={496.1} transform="translate(-6.6 7.3)" />
      <Use xlinkHref="#fk_svg__l" width={992.1} height={496.1} transform="translate(6.6 3.8)" />
      <Use xlinkHref="#fk_svg__l" width={992.1} height={496.1} transform="translate(0 11)" />
      <Path
        id="fk_svg__l"
        fill="#be0f17"
        fillRule="evenodd"
      ...
      <Path
        ...
        transform="matrix(1.255 0 0 1.312 259.4 -430)"
      />
      <Use xlinkHref="#fk_svg__l" width={992.1} height={496.1} transform="translate(0 5.5)" />
    </G>
