  ...
  >
    ...
    <G fill="#ffec2d">
      <G transform="matrix(.48 0 0 .48 345.8 201.6)">
        ...
        <G id="kz_svg__c">
          <G id="kz_svg__b">
            ...
            />
            <Use xlinkHref="#kz_svg__a" width="100%" height="100%" transform="rotate(90)" />
            <Use xlinkHref="#kz_svg__a" width="100%" height="100%" transform="scale(-1)" />
            <Use xlinkHref="#kz_svg__a" width="100%" height="100%" transform="rotate(-90)" />
          </G>
          <Use xlinkHref="#kz_svg__b" width="100%" height="100%" transform="rotate(22.5)" />
          <Use xlinkHref="#kz_svg__b" width="100%" height="100%" transform="rotate(45)" />
          <Use xlinkHref="#kz_svg__b" width="100%" height="100%" transform="rotate(67.5)" />
        </G>
        <Use xlinkHref="#kz_svg__c" width="100%" height="100%" transform="rotate(11.3)" />
      </G>
      <G transform="translate(-172.8)scale(.48)">
        ...
        <Circle cx={1019.8} cy={720.5} r={1} stroke="#ffec2d" strokeWidth={0.4} />
      </G>
