...
import Svg, { Defs, ClipPath, Rect, G, Path, Use } from 'react-native-svg';
  ...
  >
    <Defs>
      <ClipPath id="zw_svg__a">
        <Rect width={546} height={420.1} x={1.9} y={0.1} fill="#00f" fillRule="evenodd" ry={0} />
      </ClipPath>
    </Defs>
    <G clipPath="url(#zw_svg__a)" transform="matrix(1.1722 0 0 1.1426 -2.3 -.1)">
      ...
      />
      <Use xlinkHref="#zw_svg__b" width="100%" height="100%" x={-20.1} y={-0.6} />
