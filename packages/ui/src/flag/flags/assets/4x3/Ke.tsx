...
const SvgKe = (props: SvgProps) => (
  ...
  >
    ...
    <Use xlinkHref="#ke_svg__b" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)" />
    <Path
      fill="#b00"
    ...
    <Use xlinkHref="#ke_svg__c" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)" />
