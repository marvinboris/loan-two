...
const SvgAd = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="none" stroke="#703d29">
      ...
      />
      <Path strokeWidth={0.6} d="M387.5 282.9c.8-1 3.5-2.4 5.8-1.1a6.2 6.2 0 0 1 2.3 2" />
      <Path
        strokeWidth={0.9}
      ...
      />
      <Path strokeWidth={0.6} d="M397.1 192a19 19 0 0 1 18.6 19.8c0 16-9.9 18.5-13.8 19.6" />
      <Path strokeWidth={0.7} d="M398.4 192c8.1-.3 16.5 5.7 16.9 20.7.3 11.7-8 17-12 18" />
      <Path
        strokeWidth={0.6}
      ...
      <G strokeWidth={0.6}>
        ...
        <Path strokeLinecap="round" d="M243.8 202.4c1.5.8 3.1-.4 2.8-2.4a2.9 2.9 0 0 0-2.5-2.2" />
        ...
        <Path d="M329.8 169.3a4.1 4.1 0 0 0 1.5-2.2c.5-1.5.5-2.8-.2-4 1 1.4 1 2.5.7 4-.1 1-.8 1.5-1.6 2.3m51.5 86.1v16.2l-.1 2.5a34 34 0 0 1-.3 1.7" />
        ...
        <Path d="M254.6 273.7c-1-2.2-2.8-3.2-5.8-3.5s-5.5.5-8.2 1.9a18.6 18.6 0 0 0-10.8 17 25 25 0 0 0 2 9.5c.9 1.6 3 9 15.3 14a86.1 86.1 0 0 0 25.7 3.9c10.4.4 20 .8 25.6 7.6" />
        <Path
          strokeLinecap="round"
        ...
        />
        <Path d="M252.7 285.7c.3-1 .2-2.2-.8-3.3a5.1 5.1 0 0 0-6-1c-.7.5-1.6 1-2.4 2.2-.4.4-1 1.1-1.2 1.6-.7 1.1-1 2-1 2.5-2.5 7 1.5 14.4 6.5 17.6 4.4 2.8 8.8 3.6 14.4 4 2.5.3 4 .3 6.5.5h9.6a70 70 0 0 1 7.2 0c3 .3 5.1.4 7.6.8 1.6.2 3.5.5 5.4 1 .6 0 1.2.2 1.8.4l1.2.3c3.6 1.1 7 2.4 9.8 4.2.8.5 1.8 1 2.5 1.7l1.3 1.2c2 2 4 4 4.4 6.7v1.6c0 1.8-1.4 4.3-5.3 5" />
      ...
      <G stroke="#c7b37f" strokeLinecap="round" strokeWidth={0.6}>
        <Path d="M239.3 234c-.4.1-.6.2-.8.5-.3.3-.4.4-.6.9l-.2 1.2m4.7 26.7 1-1 .6-1 .5-1 .7-1.3m-1.3 14-1.5.7-1.1.6a17 17 0 0 0-1.3.8l-1.2 1m15-37.9-.8-.8-1-.8-.9-.8" />
