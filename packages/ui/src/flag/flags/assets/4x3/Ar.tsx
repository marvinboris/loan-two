...
const SvgAr = (props: SvgProps) => (
  ...
  >
    ...
    <G id="ar_svg__c" transform="translate(-64)scale(.96)">
      ...
      />
      <Use xlinkHref="#ar_svg__a" width="100%" height="100%" transform="rotate(22.5 400 250)" />
      <Use xlinkHref="#ar_svg__a" width="100%" height="100%" transform="rotate(45 400 250)" />
      <Use xlinkHref="#ar_svg__a" width="100%" height="100%" transform="rotate(67.5 400 250)" />
      <Path
        id="ar_svg__b"
        fill="#85340a"
        d="M404.3 274.4c.5 9 5.6 13 4.6 21.3 2.2-6.5-3.1-11.6-2.8-21.2m-7.7-23.8 19.5 42.6-16.3-43.9"
      />
      <Use xlinkHref="#ar_svg__b" width="100%" height="100%" transform="rotate(22.5 400 250)" />
      <Use xlinkHref="#ar_svg__b" width="100%" height="100%" transform="rotate(45 400 250)" />
      <Use xlinkHref="#ar_svg__b" width="100%" height="100%" transform="rotate(67.5 400 250)" />
    </G>
    <Use xlinkHref="#ar_svg__c" width="100%" height="100%" transform="rotate(90 320 240)" />
    <Use xlinkHref="#ar_svg__c" width="100%" height="100%" transform="rotate(180 320 240)" />
    <Use xlinkHref="#ar_svg__c" width="100%" height="100%" transform="rotate(-90 320 240)" />
    ...
    />
    <Use xlinkHref="#ar_svg__d" width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" />
    <Use xlinkHref="#ar_svg__e" width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" />
    <Use xlinkHref="#ar_svg__f" width="100%" height="100%" transform="translate(18.1)" />
    <Use xlinkHref="#ar_svg__g" width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" />
    <Path
      fill="#85340a"
    ...
    />
    <Use xlinkHref="#ar_svg__h" width="100%" height="100%" transform="translate(-18.4)" />
    <Circle id="ar_svg__f" cx={310.9} cy={236.3} r={1.8} fill="#85340a" strokeWidth={1} />
    <Path
      id="ar_svg__g"
      fill="#85340a"
      strokeWidth={1}
