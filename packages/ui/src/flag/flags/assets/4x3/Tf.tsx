...
const SvgTf = (props: SvgProps) => (
  ...
  >
    ...
    />
    <Use xlinkHref="#tf_svg__a" width="100%" height="100%" x={416} y={362} transform="scale(1.2)" />
    <Use xlinkHref="#tf_svg__a" width="100%" height="100%" x={371} y={328} transform="scale(1.2)" />
    <Use xlinkHref="#tf_svg__a" width="100%" height="100%" x={461} y={328} transform="scale(1.2)" />
    <Use xlinkHref="#tf_svg__a" width="100%" height="100%" x={333} y={227} transform="scale(1.2)" />
    <Use xlinkHref="#tf_svg__a" width="100%" height="100%" x={499} y={227} transform="scale(1.2)" />
  </Svg>
);
