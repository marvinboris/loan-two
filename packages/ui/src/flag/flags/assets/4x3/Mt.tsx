...
const SvgMt = (props: SvgProps) => (
  ...
  >
    ...
    <G fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={36}>
      ...
      />
      <Path strokeWidth={0.4} d="M181.2 166.8c.5.6 2 1.5 2.7 2 1 .8 1.4-.1.7-1.4" />
      <Path
        strokeWidth={0.3}
      ...
      <Path
        strokeWidth={0.2}
        d="M187.7 177c1.3-.7 1.3-2 3-2.6m-6.6 9.1c1.7-.8 2-1.5 3-2.2m.9-13.7c-.2 0-.6 0-.8-.3s-.3-.7-.1-.8c.1-.2.3-.1.7.2s.3.7.2.9m.3 3c-.8.2-1-.5-1.7-.6-.9-.2-1.4.4-1.4.9s.5 1 1 1c.6 0 1-.3 2.1-.2m-3.8-7.2c.6 0 1.3.2 1.7-.2"
      />
      <Path
        fill="#fff"
        strokeWidth={0.1}
      ...
      />
      <Path strokeWidth={0.3} d="M156.3 166.4c1.4 0 2.4-.2 3-1.4m8-27.9c0 2.8 1 3.5 3.2 3.9" />
      <Path
        strokeWidth={0.2}
      ...
      <Path
        fill="#fff"
        strokeWidth={0.5}
        d="M160 138.6c0-.5.2-.7.5-1 .5-.3.3-.1.6 0l.8.5c.2.2.3.1.4 0 .1-.2.1-.6.3-.8a.2.2 0 0 0 .2-.2c.2 0 .2-.1.2-.3 0-.1.1-.4.3-.4s.6.3.6 0l.3-1.6c.6.1.4-.6.6-.6.6.2.9-.8.5-1.2 0-.8.7-1 1.7-1-.1-.5-.9-.7-1.4-1.4s-2-1.6-3.8-1.6c-1.7 0-3.1 1.6-3.8 2.3-.6.7-2 1-2.3 1-.4-.1-.6-.4-1-.4H153c-.6 0-.8.4-1.5.3-.4 0-2 0-2.5.2-.4.2 0 1.2.5 1.3.2 0 1.5 0 2 .3s2 .4 2.6.1c1.3-.4 2.1.4 3.5.8l.5.1c0 .8 0 1.1-.4 1.1h-1.2l-1.3-.6c-.6-.1-1 .1-1.2.2-1.7.7-7.7 5.4-8.3 6.5-.7 1.2-1.7 1.9-2.6 3.7-.5 1-1.5 2.2-2.1 3.8-1 .5-2.1 1.4-2.3 1.7-.1.2.2.6.4.6 0 .1.3.5.6.5-.2.2.2.5.4.4 0 .2.2.7.5.7l2.4-2.5c0-1 .6-2.2 1-2.8 1.3-1.5 3-4.2 3.4-4.9.3-.4 3.2-1.5 4-2.2-.3 2-.2 3.4 0 4.6.5 2 1.1 3.3 1.5 5s0 2.7 0 3.5c.1.6.3.7 1 1 .5.4 2.9 0 3.6.3 1.4.4 2.6.5 3.1.6a5 5 0 0 1 3.5.6c.6.5 1.7 3 2.1 4 .4.9 2.6 2.1 3 2.7.5.5.9 2 .8 2.7 0 .6 0 .9.7.8.5 0 2.5.3 2.8.5.4.2 1.2.9 1.5.9s1.7.2 2.4.1.6-1.1.3-1.2a30 30 0 0 1-2-.4 8.2 8.2 0 0 1-2.7-2.1c-.6-.7-.9-1.7-1.3-2.5a58 58 0 0 0-3.1-4.5c-.2-.3-1.4-3-1.6-3.8-.3-.7-.8-.7-1.3-.9-1.8-.5-2.5-.7-4.4-1-1.3-.3-1.6-.4-1.8-1.4 0-.8-.6-2.2-.3-3.2l.4-1.8c0-.5.4-1.3.4-1.7l.2-3zm1.4 8.2c-.2 0-1 .2-1.5 0-.1 0 0-.4 0-.4s-.2-.3 0-.4c0 0-.2-.4 0-.4-.2-.2-.2-.4 0-.5.1-.1 1-.2 1.4-.1.3.5.2 1.3.1 1.8"
      />
      <Path
        strokeWidth={0.5}
        d="M158.1 135.1c.4.3.4 0 1.1-.2.8-.3 1.3.4 1 1-.2.6-.2 1.2.6 1.2s1-.7 1.2-1 .5-.3.7-.7c.2-.8 1-.6 1.5-.5m1-1.9c-.3.2-1.2-.5-1.4-1.1-.2-.8-.8-1.4-1.8-1.4s-3 .6-3.3 1.7a43 43 0 0 0-.3 1.7c-.3.1-.7 0-.7.2l-.1.8m-6.3 6.3 2-1"
      />
      <Path
        strokeWidth={0.3}
      ...
      <Path
        strokeWidth={0.2}
        d="M157 136c.9 3.2 1 4.4 3.2 5m-4.1-5.1c1 3.1 2 4.8 4.1 5m-5-5.4c1 3.1 2.4 5.3 5 5.4m11.6 24.8c-.5-.4-.6-.6-1-1.3l-.7-1.6-.5.3c-.3.1-.5-.3-.2-.4l.4-.2-.6-1.2c-.3 0 0-.2.2-.3.3-.1.6-.3.4 0l.6 1.2.4-.2c.3-.2.5.3.2.4l-.5.2.8 1.6c.4.7.5.9.5 1.5m-.1-3.4-2.4 1.3m-2.2-1.8 3.2-1.6m-3.7 1 3.3-1.6"
      />
      <Path
        strokeWidth={0.1}
