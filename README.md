...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/3KCYZlZYCi)
...
```sh
npx nx serve cfafrica
```

To create a production bundle:

```sh
npx nx build cfafrica
```

To see all available targets to run for a project, run:

```sh
npx nx show project cfafrica
```
